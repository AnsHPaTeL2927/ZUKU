<?php 
 ...
 //$fob_in_inr				= ($invoicedata->Exchange_Rate_val * );
              ...
              <div class="save_invoice_html">
                ...
                <table  width="100%" cellspacing="0" cellpadding="0" style="padding:5px" class="pdf_class invoice_edit_cls" contenteditable="false">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;font-weight:bold"> PRICE IN SQUARE METER - INR
                      </td>
                    <td style="text-align:center;font-weight:bold"> TOTAL VALUE IN INR
                     </td>
                  </tr>
                  <?php
										 		$no=1;
                  ...
                  <tr>
                    ...
                    <td rowspan="2" style="font-weight:bold; text-align:center; color:#000;border-top:0.5px solid #333;border-right:0.5px solid #333;"><?=($invoicedata->calculation_operator == 2)? $invoicedata->terms_name: 'FOB';?>
                      &nbsp;Value </td>
                    <td rowspan="2" style="font-weight:bold;text-align:right;color:black;border-top:0.5px solid #333;">
					<?=$currency_symbol_inr?>
                  ...
                  <tr>
                   <td colspan="2" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;text-align:center">
					  <!--<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;<?=number_format($invoicedata->indian_ruppe_val,2,'.','')?>-->
					</td>
                    <td   colspan="2" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;text-align:center"> 
						<span style="font-weight:bold;vertical-align:top;text-align:center">
					...
					<span style="font-weight:bold;vertical-align:top;text-align:center">
                      <?=$currency_symbol_inr?>&nbsp;<?=number_format($grand_total_inr,2,'.','')?>
                      </span>
					</td>
				 ...
				 <tr>
                  ...
                  <tr>
                    ...
                    <td  style="border-top:0.5px solid #333;font-weight:bold;text-align:right"><?=$currency_symbol_inr.number_format($grand_total_inr,2,'.','')?></td>
                  </tr>
                  <tr>
