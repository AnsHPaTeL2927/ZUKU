									...
									<div class="pull-right form-group">
										 <div class="col-sm-5">
											<div class="dropdown">
												...
												<li> <a class="tooltips" data-toggle="tooltip" data-title="View Invoice" href="<?=base_url('customerinvoiceview/index/'.$invoicedata->customer_invoice_id)?>" ><i class="fa fa-file-text-o"></i> View Invoice  </a> </li>
											 	...
											 	if(!in_array(trim($series_detail),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
												 	...
												 	if(!in_array(trim($description_goods),$product_desc_array))
													{
														...
														$product_desc_array[trim($description_goods)]['hsn'] = $product_data[$i]->custhsnccode;
								...
								else
								{
									...
									<table  width="100%" cellspacing="0" cellpadding="0" style="padding:5px" class="pdf_class invoice_edit_cls">
											...
											<tr>
												...
												<td style="text-align:center;font-weight:bold"> 
													RATE <?=$invoicedata->currency_name?>/SQM 
                                                </td>
												<td style="text-align:center;font-weight:bold"> 
													AMOUNT
											 ...
											 $no=1;
												...
												<?php 
													...
													<?php
													  ...
													  ?>
															<?php
														  		echo "<td style='text-align:center'>".$product_desc_array[$product_desc_array[$p]]['description_goods']."</td>";
															  ?>
															 <td style="text-align:center">
																<?=$product_desc_array[$product_desc_array[$p]]['hsn'];?>
															</td>
															<td style="text-align:center">
																<?=$qty?>
															</td>
											...
											?>
													<tr>
														...
														<td style="border-right:0.5px solid #333;text-align:center" ><?=$jsondata->product_size_id?> - <?=$jsondata->sample_remarks?> </td>
													 	...
													 	<td  style="border-right:0.5px solid #333;text-align:center"><?=$jsondata->no_of_pallet?>
															<?=$jsondata->no_of_boxes?>
															<?=$jsondata->sqm?>
														</td>
										...
										?>										
										 ...
										 <tr>
											<td colspan="2"   style="font-weight:bold;vertical-align:middle; text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;">&nbsp;</td>
											 
									 	    <td style="border-right:0.5px solid #333;border-top:0.5px solid #333;text-align:center"><b>TOTAL QUANTITY</b></td>
									 	   <td  style="font-weight:bold;text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;"><?=$Total_qty; ?></td>
									 	   
											 <td style="font-weight:bold;vertical-align:middle; text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;">&nbsp;</td>
...
&nbsp;Value </td>
										...
										$Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->certification_charge:$Total_amt + $invoicedata->certification_charge;  ?>
										  <tr>
												<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="4"> 
										  ...
										  <tr>
											<td colspan="4" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;"> 
										 ...
										 <?php $Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->insurance_charge:$Total_amt + $invoicedata->insurance_charge;  ?>
										  <tr>
												<td   colspan="4" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;">
									  ...
									  ?>
										  ...
										  <tr>
										    <td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="4">AMOUNT CHARGEABLE IN WORDS <span style="text-align:center">
										...
										if($invoicedata->rex_detail_status == 1)
										 ...
										 ?>
										  <tr>
											 ...
											 <td  colspan="8" style="border-top:none; vertical-align:top;">
										 ...
										 <tr>
										   <td style="border-right:0.5px solid #333;border-top:0.5px solid #333;" colspan="4">&nbsp;</td>
										   <td height="50" colspan="4" valign="top" style="border-top:0.5px solid #333;border-bottom:none;text-align:right">For
										...
										<tr>
										  ...
										  We declared that this invoice shows the actual price of the goods described & that all particulars are true and correct. <br></td>
											<td colspan="4" style="text-align:right;border-top:none" valign="bottom">
...
<?=$performa_date?>
							...
							<table  width="100%" cellspacing="0" cellpadding="0"  class="pdf_class invoice_edit_cls1">
							    <tr>
									...
									<td colspan ="3"   style="text-align:center;font-weight:bold"> Description Of Goods </td>
									<td rowspan="2" style="text-align:center;font-weight:bold">HSN CODE</td>
									<td rowspan="2" style="text-align:center;font-weight:bold">QUANTITY</td>
									<td rowspan="2" style="text-align:center;font-weight:bold">UNIT</td>
									<td rowspan="2" style="text-align:center;font-weight:bold"> NET WEIGHT (Kgs)</td>
									<td rowspan="2" style="text-align:center;font-weight:bold"> GROSS WEIGHT (Kgs)</td>
							  ...
							  <?php
								...
								$n++;
												...
												$desc = $product_data[$i]->size_type_cm.$product_data[$i]->container_no.$product_data[$i]->model_name.$product_data[$i]->no_of_boxes.$product_data[$i]->export_make_pallet_no.$product_data[$i]->custdescriptiongoods;
							  ...
							  <tr>
							    ...
							    <td style="text-align:center"><span style="font-weight:bold;text-align:center"><?=($Total_qty == 0)?"-":$Total_qty; ?> </span></td>
							  ...
							  <tr>
							    <strong> <span style="font-weight:bold;vertical-align:top;">
							      <?php if($invoicedata->remarks!='')
												   {
													?>
							      <?=nl2br($invoicedata->remarks)?>
										...
										if($invoicedata->rex_detail_status == 1)
										 ...
										 ?>
										  <tr>
											 ...
											 <td  colspan="10" style="border-top:none;vertical-align:top;">
