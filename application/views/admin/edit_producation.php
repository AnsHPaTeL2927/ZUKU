						...
						<div class="panel panel-default">
								...
								<div class="panel-body form-body">
									...
									<div class="row col-md-10 col-md-offset-1">
								 	<form role="form" class="form-horizontal" action="javascript:;" method="post" enctype="multipart/form-data" name="addition_details_form" id="addition_details_form">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												  <label>
													 <input type="radio" name="mosqure_bag_status" id="mosqure_bag_status1" value="YES"  <?=($producation_data->mosqure_bag_status == "YES")?"checked":""?> checked> 
												  		<strong for ="mosqure_bag_status1">Yes</strong>
													</label>
													  <label>
													 <input type="radio" name="mosqure_bag_status" id="mosqure_bag_status2" value="NO"  <?=($producation_data->mosqure_bag_status == "NO")?"checked":""?> > 
										...
										<!--<div class="form-group">
											...
											<div class="col-sm-3">
												  <label>
													 <input type="radio" name="separation_tiles" id="separation_tiles1" value="Brown Paper"  <?=($producation_data->separation_tiles == "Brown Paper")?"checked":""?>  > 
												  		<strong for ="separation_tiles1">Brown Paper</strong>                                    
													</label>                                                                                     
													  <label>                                                                                    
													 <input type="radio" name="separation_tiles" id="separation_tiles2" value="While Paper"  <?=($producation_data->separation_tiles == "While Paper")?"checked":""?> > 
												  		<strong for ="separation_tiles2">While Paper</strong>                                    
													</label>                                                                                     
													<label>                                                                                      
													 <input type="radio" name="separation_tiles" id="separation_tiles3" value="Foam Sheet"  <?=($producation_data->separation_tiles== "Foam Sheet")?"checked":""?> > 
												  		<strong for ="separation_tiles3">Foam Sheet</strong>                                     
													</label>                                                                                     
													<label>                                                                                      
													 <input type="radio" name="separation_tiles" id="separation_tiles4" value="Lamination"  <?=($producation_data->separation_tiles== "Lamination")?"checked":""?> > 
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												  <label>
													 <input type="radio" name="safety_belt" id="safety_belt1" value="YES"  <?=($producation_data->safety_belt == "YES")?"checked":""?>  > 
												  		<strong for ="safety_belt1">Yes</strong>
													</label>
													  <label>
													 <input type="radio" name="safety_belt" id="safety_belt2" value="NO"  <?=($producation_data->safety_belt == "NO")?"checked":""?> > 
										...
										<div class="form-group box_sticker_file_html">
											...
											<div class="col-sm-2">
											<?php
											if(!empty($producation_data->special_sticker_file))
											{
												echo "<img src='".base_url()."upload/".$producation_data->special_sticker_file."'  width='110px' height='50px'/>";
											}
									...
									<!--	<div class="col-md-12">
										...
										<br>										
											...
											<thead>
												<tr>
													...
													<th width="9%" class="text-center">Size In CM	</th>
													<th width="8%" class="text-center">Thickness	</th>
													<th width="9%" class="text-center">Images	</th>
													<th width="5%" class="text-center">Container</th>
													<th width="7%" class="text-center">Plts</th>
													<th width="7%" class="text-center">Pallet Type</th>
													<th width="6%" class="text-center">Boxes</th>
													...
													<th width="6%" class="text-center">Location</th>
											...
											<?php
												...
												<td class="text-center">
													<?php
													$one_container1 = 0;
													$no_of_boxes1 = $trn->no_of_boxes;

													if ($trn->no_of_pallet > 0) {
														// Normal pallets
														if (!empty($trn->box_per_container) && $trn->box_per_container > 0) {
															$one_container1 = $no_of_boxes1 / $trn->box_per_container;
														}
													} elseif ($trn->no_of_big_pallet > 0 || $trn->no_of_small_pallet > 0) {
														// Mixed pallets
														if (!empty($trn->multi_box_per_container) && $trn->multi_box_per_container > 0) {
															$one_container1 = $no_of_boxes1 / $trn->multi_box_per_container;
														}
													} else {
														// Direct box count
														if (!empty($trn->total_boxes) && $trn->total_boxes > 0) {
															$one_container1 = $no_of_boxes1 / $trn->total_boxes;
														}
													}
													...
													echo $one_container;
													?>
													<input type="hidden" name="product_container" id="product_container<?= $trn->performa_packing_id ?>" value="<?= $one_container ?>" />
													<input type="hidden" name="d_container<?=$trn->performa_packing_id?>" id="d_container<?=$trn->performa_packing_id?>" class="form-control" value="<?=$one_container?>"  />
												</td>
												...
												<td>
													...
													<td>
														<input type="text" name="extra_pallet<?=$trn->performa_packing_id?>" id="extra_pallet<?=$trn->performa_packing_id?>" class="form-control" value="<?=$trn->extra_pallet?>"  />
													</td>
													<td>
														<input type="text" name="location<?=$trn->performa_packing_id?>" id="location<?=$trn->performa_packing_id?>" class="form-control" value="<?=$trn->location?>"  />
													</td>
													</tr>
														<?php }
														else
										...
										<input type="hidden" name="special_sticker_file_name" id="special_sticker_file_name" value="<?=!empty($producation_data)?$producation_data->special_sticker_file:''?>"/>
										</form>
									</div>
								</div>
							 	</div>
	...
	$.ajax({
            ...
            success: function(responseData) {
				...
				if(obj.res==1)
			   {
					...
					setTimeout(function(){ window.location=root+"view_producation/index_extrapallet/"+obj.production_mst_id; },100);
			   }
