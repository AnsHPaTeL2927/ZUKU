					 ...
					 <div class="row">
						<div class="col-sm-12">
						  <ol class="breadcrumb">
								...
								<li class="active">
									Ready for export invoice
								</li>
								 
							</ol>
							<div class="page-header">
							<h3>Ready for export invoice  </h3>
							 </div>
										...
										<table class="table table-bordered table-hover display" id="datatable" width="100%">
											<thead>
												<tr>
													<th>Sr No</th>
													<th>
														<button class="btn btn-info tooltips export_btn" data-toggle="tooltip" data-title="Export Invoice" onclick="create_export_invoice()"> + Export</button>
													</th>
...
{ 	
	datatable = $("#datatable").dataTable({
			...
			"iDisplayLength": 50,
			"sAjaxSource": root+'ready_for_export/fetch_record/',
