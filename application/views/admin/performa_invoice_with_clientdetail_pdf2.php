										...
										<span class="caret"></span></button>
											<ul class="dropdown-menu">
											 <li>
												...
												?>
													<a class="tooltips" data-toggle="tooltip" data-title="PI 2" href="<?=base_url('performa_invoice_pdf/index2/'.$invoicedata->performa_invoice_id)?>" ><i class="fa fa-file-text-o"></i> PI 2</a>
...
<tr><td colspan="14"></td></tr>
										...
										<tr>
										    <td width="10%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">PRODUCT IMAGE </td>
										   <td width="8%" height="40px" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none; border-color: #000000;font-size: 7px;">SIZE</td>
										     <td width="7%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">COLLECTION</td>
										   <td width="6%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">FINISH</td>
										   <td width="8%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #00000;font-size: 7px;">PRODUCT NAME </td>
										   <td width="8%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #00000;font-size: 7px;">CLIENT CODE </td>
										
										   <td width="6%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">BOXES / PALLET	</td>
										    <td width="6%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">CONT.</td>
										   <td width="5%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">PALLETS
										   </td>
										   <td width="6%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">TOTAL BOXES</td>
										  
										   <td width="8%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">QUANTITY (<?=$invoicedata->per_value?>) </td>
										    <td width="6%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">WEIGHT</td>
										   
										   <td width="6%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;font-size: 7px;">RATE / <?=$invoicedata->per_value?> (<?=strtoupper($invoicedata->currency_name)?>)</td>
										   <td width="10%"  style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;border-bottom: none;border-color: #000000;font-size: 7px;">AMOUNT (<?=strtoupper($invoicedata->currency_name)?>)</td>
...
?>
        <tr>
            ...
            <td style="text-align:center;border-color:#000000;"><?= $packing_row->client_name ?></td>
            ...
            <td style="text-align:center;border-color:#000000;"><?= $currency_symbol ?><?= number_format($packing_row->product_rate, 2, '.', '') ?></td>
            <td style="text-align:center;border-color:#000000;"><?= $currency_symbol ?><?= number_format($packing_row->product_amt, 2, '.', '') ?></td>
        </tr>
<?php
...
?>
					 			 ...
					 			 <tr>
										<td colspan="7" style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;border-color: #000000;background-color:#F2F2F2 ;color:#000000;font-size:11px;">TOTAL >>>></td>
										...
										<td style="text-align:center;font-weight:bold;border-bottom: none;border-color: #000000;background-color:#F2F2F2 ;color:#000000;font-size:11px;"><?=$currency_symbol?><?=number_format($Total_ammount,2,'.',',')?> 
								 ...
								 <tr>
										...
										<td colspan="9" style="border-bottom: none;font-weight:bold;    border-right: none;"> <?=($invoicedata->currency_name == "INR")?strtoupper(converttorsword($invoicedata->grand_total,$invoicedata->currency_name)):strtoupper(convertamonttousd($invoicedata->grand_total,$invoicedata->currency_name))?> ONLY
										</td>
										<td  colspan="2" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;font-size: 11px;">TOTAL <?=$invoicedata->terms_name?> VALUE</td>
									 	<td style="text-align:center;font-weight:bold;border-bottom: none;font-size: 11px;"><?=$currency_symbol?><?=number_format($invoicedata->grand_total,2,'.',',')?> 
										</td>
								 </tr>
								
							 	 <tr>
									
										<td rowspan="2"  colspan="6" style="border-right:1px soild;vertical-align:top;line-height:12px;padding-top:10px">
...
function edit_invoice()
{
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"invoice_table_name"	: 'performa_invoice_with_clientdetail_pdf2'   
		}, 
	...
	block_page();
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"performa_invoice_pdf"	: 'performa_invoice_with_clientdetail_pdf2'
	   }, 
       success: function (response)
	   {
			 unblock_page("success","invoice Updated"); 
