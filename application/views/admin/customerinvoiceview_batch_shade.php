							...
							<div class=" panel-default">
							  ...
							  ob_start();
											...
											{	
												...
												$series_detail =  $product_data[$i]->custdescriptiongoods;
											 	...
											 	if(!in_array(trim($series_detail),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
													...
													$description_goods =  $product_data[$i]->description_goods.$product_data[$i]->custproductrate;
								...
								else
								{
									...
									<table cellspacing="0" cellpadding="0" width="100%" class="pdf_class invoice_edit_cls">
											...
											<tr>
												 ...
												 <td><strong>Buyer Order No &amp; Date :</strong></td>
												 <td> 
												  
												  <?php
													if(!empty($invoicedata->customer_buy_order_no))
													{
													?>
													<?=$invoicedata->customer_buy_order_no?>
													<?php
													}
													?>
												  </td>
									...
									<table  width="100%" cellspacing="0" cellpadding="0" style="padding:5px" class="pdf_class invoice_edit_cls">
											...
											<tr>
												<td rowspan="2" style="text-align:center;font-weight:bold">Marks & Nos</td>
												 <td  rowspan="2" style="text-align:center;font-weight:bold">DESCRIPTION OF GOODS : <br>
												DIGITAL GLAZED VITRIFIED TILES <br>
												HSN Code - 69072100</td>
											 ...
											 <tr>
												...
												<td colspan="2" style="text-align:center;font-weight:bold"> RATE <?=$invoicedata->currency_name?>/SQM 
                                                </td>
												<td colspan="2" style="text-align:center;font-weight:bold"> AMOUNT
								 	...
								 	?>
											 ...
											 $no=1;
												...
												?>			 
															 ...
															 <?=($Total_pallet == 0)?" ":$Total_pallet.'<span style="text-align:center;font-weight:bold"> PALLETS<br></span>' ?>
															  <?=$Total_box?>
															  <span style="text-align:center;font-weight:bold"> BOXES</span>
															<?php
													  }
													  ?>
															</td>
										...
										?>										
										 ...
										 <tr>
											<td colspan="2" rowspan="2"   style="font-weight:bold;vertical-align:middle; text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;">&nbsp;</td>
											...
											<td rowspan="2" colspan="2" style="font-weight:bold; text-align:center; color:#000;border-top:0.5px solid #333;border-right:0.5px solid #333;"><?=($invoicedata->calculation_operator == 2)? $invoicedata->terms_name: 'FOB';?>
&nbsp;Value </td>
						...
						<div class="profile-pic">
							...
							<table  width="100%" cellspacing="0" cellpadding="0"  class="pdf_class invoice_edit_cls1">
							    <tr>
									...
									<td colspan="6" style="text-align:center;font-weight:bold"> DESCRIPTION OF GOODS : <br>
					DIGITAL GLAZED VITRIFIED TILES <br>
					HSN Code - 69072100
									<!--<br>
							  ...
							  <tr>
							    ...
							    <td width="15%" style="text-align:center;font-weight:bold"> CONTAINER NO.</td>
							    <td width="6%" style="text-align:center;font-weight:bold"> RFID SEAL NO.</td>
							    <td width="6%" style="text-align:center;font-weight:bold">LINE SEAL NO.</td>
								...
								<td width="5%" style="text-align:center;font-weight:bold"> GRADE NO.</td>
							    ...
							    <td width="6%" style="text-align:center;font-weight:bold">SQM</td>
						 	    <td width="10%" style="text-align:center;font-weight:bold"> NET WEIGHT (Kgs)</td>
							    <td width="10%" style="text-align:center;font-weight:bold"> GROSS WEIGHT (Kgs)</td>
						      </tr>
							  <?php
								...
								$n++;
												...
												$desc = $product_data[$i]->custdescriptiongoods.$product_data[$i]->size_type_cm.$product_data[$i]->container_no.$product_data[$i]->model_name.$product_data[$i]->no_of_boxes.$product_data[$i]->export_make_pallet_no;
							  ...
							  <tr>
							   ...
							   <td style="text-align:center;border-bottom:none;border-top:none" >&nbsp;</td>
							    ...
							    <td style="text-align:center;border-bottom:none;border-top:none" >&nbsp;</td>
							    <td style="text-align:center;border-bottom:none;border-top:none" >&nbsp;</td>
							    <td colspan="2" style="text-align:center;border-left:none;border-bottom:none;border-top:none" >&nbsp;</td>
										...
										if($invoicedata->rex_detail_status == 1)
										 ...
										 ?>
										  <tr>
											 ...
											 <td  colspan="14" style="border-top:none;vertical-align:top;">
