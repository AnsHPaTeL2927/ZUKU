...
function view_pdf(no)
{
	if(no==1)
	{
						...
						<div class="panel panel-default">
								...
								else
								{
									...
									<table cellspacing="0" cellpadding="0"  width="100%" class="main_table invoice_edit_cls" border="1">
										...
										<tr>
											<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;" width="25%"> Country of Origin Of Goods </td>
											<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;" width="10%"> Port Of Loading </td>
											<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;" width="10%"> Port Of Discharge </td>
											<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;" width="10%"> Final Destination</td>
											<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;" width="20%"> Number Of Container </td>
											<td style="text-align:center;font-weight:bold;border-bottom: none;" width="25%"> Approx Weight of Container (KG) </td>
									 	</tr>
										<tr>
											<td style="text-align:center;border-bottom: none;border-right: none;"> <?=$invoicedata->country_origin_goods?>	 </td>
	  ...
	  ?>
										<tr>
											<td style="text-align:center;font-weight:bold" colspan="14"> <?=implode(",",$hsn_array)?></td>
										</tr>
										<tr>
										   ...
										   <td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Client Name</td>
										   <td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Barcode</td>
										   ...
										   <td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Pallets	</td>
										    ...
										    <td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Quantity (<?=$invoicedata->per_value?>) </td>
										   <td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Rate / <?=$invoicedata->per_value?> (<?=strtoupper($invoicedata->currency_name)?>)</td>
								...
								?>
									<tr>
										<td style="text-align:center;border-bottom: none;border-right: none;"><?=$product_data[$i]->size_type_cm?>
										<br>
										...
										<td style="text-align:center;border-bottom: none;border-right: none;"><?=$packing_row->client_name?></td>
										<td style="text-align:center;border-bottom: none;border-right: none;"><?=$packing_row->barcode_no?></td>
								...
								?>
			 					 ...
			 					 <tr>
										<td colspan="7" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;">Total</td>
								 ...
								 ?>
									 <tr>
										<td colspan="9" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;"> </td>
								 ...
								 <tr>
										...
										<td colspan="8" style="border-bottom: none;font-weight:bold;    border-right: none;"> <?=($invoicedata->currency_name == "INR")?strtoupper(converttorsword($invoicedata->grand_total,$invoicedata->currency_name)):strtoupper(convertamonttousd($invoicedata->grand_total,$invoicedata->currency_name))?> ONLY
										</td>
	...
	block_page();
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"performa_invoice_pdf"	: 'performa_invoice_pdf2'
	   }, 
...
function edit_invoice()
{
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"invoice_table_name"	: 'performa_invoice_pdf2'  
		}, 
       success: function (response)
	   {
			 unblock_page("success","invoice Updated"); 
