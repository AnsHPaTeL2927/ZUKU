...
function view_pdf(no)
{
	if(no==1)
	{
		window.open(root+"performa_invoice_pdf4/view_pdf", '_blank');
	}
	else{
		window.location= root+"performa_invoice_pdf4/view_pdf";
	}
						...
						<div class="panel panel-default">
							...
							// $seriesname_array=array();
								...
								{ 
								  ...
								  {
											$key = $product_data[$i]->size_type_mm . $packing_row->box_design_name . $product_data[$i]->thickness;
								...
								?>
											  ...
											  <?php 
												...
												$hsnc_code1 = $product_data[$i]->series_name.' - HSN Code:'.$product_data[$i]->hsnc_code;
								  ?>
									<tr>
									  ...
									  <td style="text-align:center;border-right: none;">
										...
										<?php 
											...
											{
											?>
												<td colspan="5" style="text-align:center;border-right: none;">																								<?=$product_data[$i]->description_goods?><br>												<b>Net Weight : </b><?=$product_data[$i]->total_net_weight?><br>												<b>Gross Weight : </b><?=$product_data[$i]->total_gross_weight?>																																				</td>
