				...
				<div class="col-sm-12">
				 ...
				 <div class="col-md-12"  style="height:20px"></div>
					...
					<div class="col-md-5">
						...
						<div class="col-sm-7">
							 <select class="select2" name="country_id" id="country_id" required title="Select Country" onchange="customer_report()">
								<option value="">ALL Country</option>
									<?php 	
										for($i=0; $i<count($country_list);$i++)
										{
									?>	
											<option <?=$selected?> value="<?=$country_list[$i]->id?>"><?=$country_list[$i]->c_name?></option>	
										<?php
									}
									?>
							</select>
...
function customer_report()
{
	...
	$.ajax({          
		type: "POST",          
		url: root+'profit_report/view_report',         
		data: {          
