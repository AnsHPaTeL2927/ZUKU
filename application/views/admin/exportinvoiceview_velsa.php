<?php 
 ...
 $companyname 				= $invoicedata->c_companyname;
              ...
              <div class="save_invoice_html1">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" class="pdf_class invoice_edit_cls1" contenteditable="false">
                 ...
                 <!-- <tr>
                  ...
                  <tr>
                    <!--<td colspan="2" style="font-weight:bold"> Consignor/Exporter/Manufacturer:</td>-->
                    <td><span style="font-weight:bold">Seller :</span></td>
                    <td>
					<?php
														if($company_detail[0]->s_c_type == "Merchant")
														{
                  ...
                  <tr>
                   ...
                   <!-- <td  rowspan="3" style="vertical-align:top;border-left:none"><span style="vertical-align:top;border-right:none"> <strong>GST No : </strong>
                    ...
                    <td   style="font-weight:bold" valign="top">Buyer : </td>
                    <td valign="top"><?=$companyname?></td>
                   <!-- <td  colspan="2" valign="top"><?=$performa_date?></td>-->
                  </tr>
				    <tr>
                    <td   style="font-weight:bold" valign="top">Country : </td>
                    <td   valign="top"><?=$final_destination?></td>  
                  </tr>
                  <tr>
                    <td   style="font-weight:bold" valign="top">Invoice : </td>
                    <td   valign="top"><?=$exportinvoice_no?></td>  
                  </tr>
				  <tr>
                    <td   style="font-weight:bold" valign="top">Date : </td>
                    <td   valign="top"><?=$export_date?></td>  
                  </tr>
				  <tr>
                    <td   style="font-weight:bold" valign="top">Country Of Origin : </td>
                    <td   valign="top"><?=$country_origin_goods?></td>  
				 </tr>
										...
										<!--	<?php
												...
												for($p=0;$p<count($product_desc_array);$p++)
												{
											 	 ...
											 	 ?>
												   <tr>
													  <td   style="font-weight:bold" valign="top">Description Of Good </td>
                  ...
                  <tr>
                    <td colspan="2"><strong>Description Of Products  : </strong><br>
					<?php
										 		$no=1;
											...
											$no++;
												...
												?>
												<br>
                      <?=$invoicedata->export_buy_order_no?>
					 </td>
                   
                  </tr>
				  <tr>
                    <td   style="font-weight:bold" valign="top">Shipment Date: </td>
                    <td   valign="top"><?=$export_date?></td>  
                  </tr>
                ...
                <table  width="100%" cellspacing="0" cellpadding="0" style="border:none" class="pdf_class invoice_edit_cls1" contenteditable="false">
                  <tr>
                    <td style="text-align:center;font-weight:bold"> Container</td>
                    <td style="text-align:center;font-weight:bold"> Shade </td>
                    <td style="text-align:center;font-weight:bold">Caliber</td>
                    <td style="text-align:center;font-weight:bold">Pcs/PALLET</td>
                    <td style="text-align:center;font-weight:bold">Pcs/container</td>
                    <td style="text-align:center;font-weight:bold">Number of pallets/conatiner</td>
                    <td style="text-align:center;font-weight:bold">Description Of Products</td>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center" rowspan="<?=$rowcon_no?>"><?=$product_data[$i]->shade_no?></td>
                    ...
                    <?php 
												...
												{
												?>
                    <td style="text-align:center" ><?=($Total_pallet * $product_data[$i]->pcs_per_box)?></td>
                    <td style="text-align:center" ><?=($product_data[$i]->origanal_boxes * 2)?></td>
                    <?php
												}
												else
												{
                    ...
                    <?php
													 ...
													 <td style="text-align:center" ><?=$product_data[$i]->model_name?>&nbsp;<?=$product_data[$i]->size_type_mm?>&nbsp;<?=$product_data[$i]->finish_name?> </td>	
													 <?php
													if($no>1)
													{
														echo "</tr>";
