										...
										$rowspan = 0;
											...
											{	
											 	...
											 	if(!in_array(trim($product_data[$i]->series_name.'<br> HSN Code - '.$product_data[$i]->hsnc_code),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
													$Total_ammount	 += ($product_data[$i]->custproductrate * ($product_data[$i]->origanal_boxes * $product_data[$i]->sqm_per_box));
													$Total_amt 	 	 += ($product_data[$i]->custproductrate * ($product_data[$i]->origanal_boxes * $product_data[$i]->sqm_per_box));
									...
									?>
										...
										?>										
										 ...
										 <tr>
											...
											<td rowspan="2" style="font-weight:bold; text-align:center; color:#000;border-top:0.5px solid #333;border-right:0.5px solid #333;">FOB &nbsp;Value </td>
									  ...
									  ?>
										...
										$Total_amt = $Total_amt + $invoicedata->certification_charge;?>
										 ...
										 $Total_amt = $Total_amt + $invoicedata->seafright_charge; 
										 ...
										 <tr>
										  ...
										  <tr>
										    ...
										    <td rowspan="2" colspan="2" style="border-right:0.5px solid #333;text-align:center"> 
													CIF in <?=$invoicedata->currency_name?> 
												</td>
