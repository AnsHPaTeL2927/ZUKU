...
function view_pdf(no)
{
	if(no==1)
	{
	  ...
	  ?>
										<tr>
											<td style="text-align:center;font-weight:bold" colspan="10"> <?=implode(",",$hsn_array)?></td>
										</tr>
										<tr>
										   <td width="12%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Size</td>
										   <td width="12%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Name</td>
										   <td width="12%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Image</td>
										   <td width="12%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Finish</td>
										   
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Total Boxes</td>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Container</td>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Quantity (<?=$invoicedata->per_value?>) </td>
										   ...
										   <td width="14%"  style="text-align:center;font-weight:bold;border-bottom: none;">Amount (<?=strtoupper($invoicedata->currency_name)?>)</td>
								 	   </tr>
...
$Total_sqm 	+= $packing_row->no_of_sqm;										
								...
								?>
								 ...
								 <tr>
										...
										<td colspan="4" style="border-bottom: none;font-weight:bold;    border-right: none;"> <?=($invoicedata->currency_name == "INR")?strtoupper(converttorsword($invoicedata->grand_total,$invoicedata->currency_name)):strtoupper(convertamonttousd($invoicedata->grand_total,$invoicedata->currency_name))?> ONLY
										</td>
							 	 ...
							 	 <tr>
										<td rowspan="2"  colspan="3" style="border-right:1px soild;vertical-align:top;">
										...
										<td colspan="6" style="border-right:1px soild;vertical-align:top;">
											...
											<tr>
												<th width="33%" style="text-align:center" >Size</th>
												<th width="33%" style="text-align:center" >Pcs / box</th>
												<th width="33%" style="text-align:center" > Sqm / box</th>
	...
	block_page();
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"performa_invoice_pdf"	: 'performa_invoice_pdf11'
	   }, 
...
function edit_invoice()
{
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"invoice_table_name"	: 'performa_invoice_pdf11'   
		}, 
       success: function (response)
	   {
			 unblock_page("success","invoice Updated"); 
