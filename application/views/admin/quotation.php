...
{
	$Today_Date= date('d-m-Y',strtotime($invoicedata->quotation_date));
	$invoice_no=$invoicedata->estimate_no;
			 ...
			 <div class="row">
			 	<div class="col-sm-12">
			 		<ol class="breadcrumb">
			 			...
			 			<li class="active">
			 				<a href="<?=base_url().'invoice_listing'?>">Quotation List</a>
			 			</li>
			 	...
			 	<div class="col-sm-12">
			 		<div class="panel panel-default">
			 			<div class="panel-heading">
			 				...
			 				<?=($mode=="Edit")?$mode:'Create New'?> Quotation	
			 			</div>
                         <div class="">
						 ...
						 <table cellspacing="0" cellpadding="0" class="table table-bordered">
								...
								<tr>
										...
										<td colspan="2" style="font-weight:bold;">
											...
											<label id="invoice_currency_id-error" class="error" for="invoice_currency_id"> </label>
										</td>
								...
								<tr>
									...
									<td>Quotation No</td>
									<td>
										<input type="text" placeholder="Quotation No" style="font-weight:bold;" id="invoice_no" required="" class="form-control" name="invoice_no" value="<?=$invoice_no?>" <?=($invoicedata->confirm_status == 1)?"readonly":""?> title="Enter Quotation No">
							  ...
							  <tr>
									...
									<td colspan="3">
										...
										<option value="Other" style="color:blue">Other Consign</option>
										<?php 
									...
									<td>
									 ...
									 <td colspan="3">
											<input type="text" placeholder="Port Of Discharge" style="font-weight:bold;" id="port_of_discharge" class="form-control" name="port_of_discharge" value="<?=$invoicedata->port_of_discharge?>" title="Enter Port Of Discharge">
									</td>
								</tr>
								 <tr>
									<td colspan="6">
						   ...
						   <tr>
									<td colspan="5">Max. Weight Limit Of Containter(KG)</td>
									 
										<td colspan="2">
										<input type="text" style="font-weight:bold;"  placeholder="Max. Weight Limit Of Containter" id="limit_container"   class="form-control multiple_input" name="limit_container" value="<?=$invoicedata->limit_container?>"  title="Enter Max. Weight Limit Of Containter">
									...
									<td rowspan="2">NOTES :</td>
									 <td colspan="3" rowspan="2">
										<textarea class="form-control" rows="2" name="remarks" id="remarks" style="font-weight:bold;height:auto;"  ><?=strip_tags($remarks)?></textarea>
									</td>
							</tr>
							<tr>
							...
							<input type="hidden" name="estimate_id" id="estimate_id" value="<?=$invoicedata->estimate_id?>"/>			
					 </form>
            ...
            success: function(responseData) {
			   ...
			   if(obj.res==1)
			   {
				   //$("#invoice_form").trigger('reset');
					...
					setTimeout(function(){ window.location=root+'quotation_product/index/'+obj.quotationid; },1500);
				}
				else if(obj.res==3)
			   {
				   $("#invoice_form").trigger('reset');
...
function  load_consigner(cidval){
        ...
        $.ajax({
          type :'POST',
          url  :root+'quotation/selectcompnay',
          data :{
            'e_id' : cidval,
            'type' : 'consigner'
          },
