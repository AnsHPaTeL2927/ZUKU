											 	...
											 	if(!in_array(trim($series_detail),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
												 	...
												 	if(!in_array(trim($description_goods),$product_desc_array))
													{
														...
														$product_desc_array[trim($description_goods)]['batch_no'] = $product_data[$i]->batch_no;
								...
								else
								{
									...
									<table  width="100%" cellspacing="0" cellpadding="0" style="padding:5px" class="pdf_class invoice_edit_cls">
											<tr>
												...
												<td style="padding:0;border-top:none;border-bottom:none" width="25%"></td>
											...
											<tr>
												<td rowspan="2" style="text-align:center;font-weight:bold">Marks & Nos</td>
												 ...
												 <td  rowspan="2" style="text-align:center;font-weight:bold">BATCH NO</td>
									...
									if(!empty($invoicedata->container_forty))
									{
								 	...
								 	?>
												...
												for($p=0;$p<count($product_desc_array);$p++)
												{
											 	 ...
											 	 ?>
													  ...
													  ?>														
															...
															<td style="text-align:center">
																<?=$product_desc_array[$product_desc_array[$p]]['batch_no']?>
															</td>
										...
										?>										
										 ...
										 <tr>
											<td colspan="4" rowspan="2"   style="font-weight:bold;vertical-align:middle; text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;">&nbsp;</td>
...
&nbsp;Value </td>
										...
										$Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->certification_charge:$Total_amt + $invoicedata->certification_charge;  ?>
										  <tr>
												<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="6"> 
										  ...
										  <tr>
											<td colspan="6" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;"> 
										 ...
										 <?php $Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->insurance_charge:$Total_amt + $invoicedata->insurance_charge;  ?>
										  <tr>
												<td   colspan="6" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;">
									  ...
									  ?>
										...
										if($invoicedata->rex_detail_status == 1)
										 ...
										 <tr>
										   <td style="border-right:0.5px solid #333;border-top:0.5px solid #333;" colspan="6">&nbsp;</td>
