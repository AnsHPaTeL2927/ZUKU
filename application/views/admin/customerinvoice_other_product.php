...
&nbsp;Value </td>
										...
										$Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->certification_charge:$Total_amt + $invoicedata->certification_charge;  ?>
										  <tr>
												<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="3"> 
										 ...
										 <?php $Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->insurance_charge:$Total_amt + $invoicedata->insurance_charge;  ?>
										  <tr>
												<td   colspan="3" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;">
										 ...
										 <?php 
										  ...
										  <tr>
										    <td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="3">AMOUNT CHARGEABLE IN WORDS <span style="text-align:center">
										...
										if($invoicedata->rex_detail_status == 1)
										 ...
										 ?>
										  <tr>
											 ...
											 <td  colspan="6" style="border-top:none; vertical-align:top;">
										 ...
										 <tr>
										   <td style="border-right:0.5px solid #333;border-top:0.5px solid #333;" colspan="3">&nbsp;</td>
										...
										<tr>
											<td style="border-right:0.5px solid #333;border:0.5px solid #333;" colspan="3">
										...
										if($invoicedata->rex_detail_status == 1)
										 ...
										 ?>
										  <tr>
											 ...
											 <td  colspan="9" style="border-top:none;vertical-align:top;">
