							...
							if(!empty($invoice_html_data))
								{
									echo '<div class="pull-right">
											<a class="btn btn-danger tooltips" data-title="Delete" href="javascript:;"  onclick="delete_editable('.$invoicedata->taxinvoice_id.')"   ><i class="fa fa-trash"></i> Delete (Edited version)</a>
										</div>	
										';
								}
							?>      
						...
						<div class="form-body panel-body">
							...
							<div class="profile-pic">
								...
								else
								{
								 ...
								 <table cellspacing="0" cellpadding="0"    width="100%"  class="pdf_class invoice_edit_cls">
									...
									<tr>
										...
										<td colspan="5"   style="padding: 5px; margin: 0; vertical-align: top;font-weight:bold">
											 <?=$export?>
									 	</td>
									...
									<tr>
										...
										<td rowspan="3" style="vertical-align:top;font-weight:bold" colspan="3">
												<?=$buy_order_no?>
									...
									<tr>
										...
										<td>X</td>
										<td  style="font-weight:bold">20FT FCL</td>
										<td colspan="2" style="font-weight:bold">
								 ...
								 <table  width="100%" cellspacing="0" cellpadding="0"  class="pdf_class invoice_edit_cls">
									<tr>
									 ...
									 <tr>
									 	...
									 	<td colspan="2" style="text-align:center">Quantity Details</td>
									...
									<tr>
										<tr>
													...
													<td></td>
											<td  colspan="2">
											<?=$product_data[$p]->description_goods?>
											
											</td>
											<td style="text-align:center"><?=$product_data[$p]->origanal_boxes?></td>
											<td style="text-align:center"> <?=$product_data[$p]->no_of_sqm?></td>
											<td style="text-align:center" id="product_rate_html<?=$product_data[$p]->exportproduct_trn_id.$p?>">
								  ...
								  if($sample_data != 0)
									{
										?>
										<tr>
														 	<td colspan="5" style="font-weight:bold">Sample</td>
									...
									?>
										<tr>
														<td colspan="2"> </td>
														<td > </td>
													 	<td  colspan="2"><?=$sample_data[$s]->sample_desc?></td>
									...
									<tr>
										...
										<td style="font-weight:bold;text-align:center"><?=$Total_sqm; ?></td>
									...
									<tr>
												 ...
												 <td colspan="4" rowspan="2" style="vertical-align:top;text-align:right;font-weight:bold">
								...
								<?php
									 ...
									 $_SESSION['export_invoice_no'] = $invoice_no;
...
function delete_editable(taxinvoice_id)
{
	Swal.fire({
  ...
  confirmButtonText: 'Yes, do it!'
	...
	block_page();
     ...
     $.ajax({ 
       ...
       data:
	   {
			"performa_invoice_id"	: taxinvoice_id,
			"performa_invoice_pdf"	: 'tax_invoice',
			"invoiceview"	        : 'tax_invoice'
	   }, 
...
function edit_invoice()
{
     ...
     $.ajax({ 
       type: "POST", 
       url: root+"taxinvoiceview/invoice_html_update",
       data:
	   {
			"taxinvoice_id"	: <?=$invoicedata->taxinvoice_id?>, 
