...
function view_pdf(no)
{
	if(no==1)
	{
								...
								else
								{
									...
									<!--<table cellspacing="0" border="1" cellpadding="0"  width="100%" class="main_table invoice_edit_cls">
										...
										<tr>
											 <td style="text-align:right;border-top:none;border-bottom:none;border-left:none;font-size:13;vertical-align:top;">
												...
												<strong> <?=!empty($invoicedata->buy_order_no)?'BUYER ORDER NO : '.$invoicedata->buy_order_no:''?>  </strong> <br> 
												<strong> <?=!empty($invoicedata->contactperson_name)?'AGENT / REPRESENTATIVE : '.$invoicedata->contactperson_name:''?>  </strong> <br> 
												<strong> <?=!empty($company->s_iec)?'IEC : '.$company->s_iec:''?>  </strong> <br> 
												<strong> <?=!empty($company->s_gst)?'GST : '.$company->s_gst:''?>  </strong> <br> 
												</span>
											</td>
										</tr>
								</table>-->
									<table cellspacing="0" cellpadding="0"  width="100%" class="main_table invoice_edit_cls" border="1">
									 <tr>
									  ...
									  <tr>
										<td colspan="6"  style="font-weight:bold;vertical-align: bottom;text-align: center;font-size:16px;">PROFORMA INVOICE</td>
									  </tr>
									<tr>
											<td colspan="3"   style="vertical-align:top;border-right: none;border-bottom:none"> 
											 <img src="<?=base_url().'upload/'.$company_detail[0]->head_logo?>" style="width:250px"  width="<?=$company->head_logo_width?>" height="<?=$company->head_logo_height?>" />
									        <br>
											</td>
										...
										<tr>
										 ...
										 <tr>
											<td colspan="3"  style="border-right:none;border-bottom: none;">
												<strong>Expoter Bank Details </strong>				
											</td>
											<td colspan="3" style="border-bottom: none;">
												 <strong>Terms Of Payment & Delivery</strong>										
											</td>
									 	</tr>
										 <tr>
											<td colspan="3"   style="vertical-align:top;border-right: none;border-bottom:none"> 
	  ...
	  ?>
										...
										<tr>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product & Size</td>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Name</td>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Image</td>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Finish</td>
										   ...
										   <td width="8%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Quantity (<?=$invoicedata->per_value?>) </td>
...
$Total_sqm 	+= $packing_row->no_of_sqm;										
								...
								?>
					 			 <tr>
										<td colspan="5" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;"><strong>Total</strong></td>
								 ...
								 <tr>
										<td colspan="6" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;"></td>
										 
										<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;"> PALLET </td>
										<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;"> BOXES</td>
									
										
										
										<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;"> SQM</td>
										<td  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;"> </td>
										<td style="text-align:center;font-weight:bold;border-bottom: none;">AMOUNT 
										</td>
								 </tr>
								 <?php 
								 ...
								 ?>
									 <tr>
									 	<td colspan="8" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;"> </td>
										<td colspan="2" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;">Sea Freight Charges</td>
								 ...
								 ?>
									 <tr>
									 	<td colspan="8" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;"> </td>
										<td colspan="2" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;">Courier Charges</td>
								 ...
								 ?>
									 <tr>
										<td colspan="8" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;"> </td>
										<td colspan="2" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;">Bank Charges</td>
								 ...
								 <tr>
										...
										<td  colspan="2" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;">Total Payble <?=$invoicedata->terms_name?> Amount</td>
									 	<td style="text-align:center;font-weight:bold;border-bottom: none;"><?=$currency_symbol?><?=number_format($invoicedata->grand_total,2,'.',',')?> 
										</td>
								 </tr>
							 	 <tr>
										<td rowspan="2"  colspan="5" style="border-right:1px soild;vertical-align:top;">
										...
										<td colspan="6" style="border-right:1px soild;vertical-align:top;">
											...
											<tr>
												...
												<th width="20%" style="text-align:center" >Pcs / box</th>
												<th width="20%" style="text-align:center" > Sqm / box</th>
												<th width="20%" style="text-align:center" >Pallet Type</th>
												<th width="20%" style="text-align:center" >Box Design </th>
											</tr>
