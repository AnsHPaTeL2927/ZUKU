...
function view_pdf() 
{
    let url = root + "view_producation_sheet_pending/view_pdf?" +
			...
			<div class="row">
				<div class="col-sm-12">
					<ol class="breadcrumb">
						...
						<li class="active">
							Producation Sheet Data 
						</li>
						 
					</ol>
					<div class="page-header">
					<h3>	Producation Sheet Data </h3>
				 ...
				 <div class="col-md-12"  style="height:20px"></div>
					...
					<!--<div class="col-md-5">
						...
						<div class="col-sm-7">
							<select class="select2" id="pi_no" onchange="customer_report()">
					...
					<div class="col-md-5">
						...
						<div class="col-sm-7">
							<select class="select2" id="production_status" onchange="customer_report()">
...
function customer_report()
{
	...
	$.ajax({          
		type: "POST",          
		url: root+'view_producation_sheet_pending/view_report',         
		data: {          
			"customer_id" 	: $("#customer_id").val(), 
			"finish_id" 	: $("#finish_id").val(), 
			"pallet_type" 	: $("#pallet_type").val(), 
