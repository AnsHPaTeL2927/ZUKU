										...
										<span class="caret"></span></button>
											<ul class="dropdown-menu">
											 <li>
													...
													<a class="tooltips" data-toggle="tooltip" data-title="PI 2" href="<?=base_url('view_producation/index_extrapallet/'.$producation_mst->production_mst_id)?>" ><i class="fa fa-file-text-o"></i> PO 1</a>
                                        ...
                                        <div class="save_invoice_html">
                                            ...
                                            if (!empty($invoice_html_data)) {
                                                ...
                                                <table class="main_table invoice_edit_cls" border="1" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <th colspan="10" style="text-align:center;background-color:#DAEEF3;font-size:15px;"
                                                           > PURCHASE ORDER
                                                            </th>
                                                    ...
                                                    <tr>
                                                         <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="13%">DESIGN IMAGE</th>
                                                             <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="10%">SIZE </th>
                                                            <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="8%">COLLECTION </th>
                                                            <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="10%">FINISH</th>
                                                            <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="10%">DESIGN NAME</th>
                                                            <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="10%">CLIENT DESIGN NAME</th>
                                                            <!--<th style="text-align:center;background-color:#DAEEF3;color:#000000"-->
                                                            <!--width="7%">BARCODE</th>-->
                                                            <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="8%">CONT.</th>
                                                              <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="8%">BOX/ PALLETS</th> 
															
															<th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="7%">PALLET QTY</th>
                                                            <th style="text-align:center;background-color:#DAEEF3;color:#000000"
                                                            width="7%">BOX QTY</th>
                                                                ...
                                                                if ($design_array[$design_array[$i]]['product_id'] == 0) {
                                                                   ...
                                                                   <td style="font-weight:bold;font-size: 11px">
                                                                    ...
                                                                    <td
                                                                     ...
                                                                     <td
                                                                        style="text-align:center;font-weight:bold;color:#000000;font-size: 11px">
                                                                        <?= $design_array[$design_array[$i]]['client_name'] ?>
                                                                    </td>
                                                                    <!-- <td-->
                                                                    <!--    style="text-align:center;font-weight:bold;color:#000000;font-size: 11px">-->
                                                                    <!--    <?= $design_array[$design_array[$i]]['barcode_no'] ?>-->
                                                                    <!--</td>-->
