								...
								<div class="panel-body">
									<form role="form" class="form-horizontal" action="javascript:;" method="post" enccap="multipart/form-data" name="pallet_cap_add" id="pallet_cap_add">
									 	<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="text" placeholder="User Type" id="user_type" class="form-control" name="user_type" />
											</div>
										</div>
			 ...
			 <form class="form-horizontal askform" action="javascript:;"  method="post" name="edit_pallet_cap" id="edit_pallet_cap">
				<div class="modal-body">
					 <div class="form-group">
					 	...
					 	<div class="col-sm-12">
					 		<input type="text" placeholder="User Type" id="edit_user_type" class="form-control" name="edit_user_type" value="" >
					 	</div>
					</div>
		 		   </div>
...
function load_data_table()
{
	datatable = $("#datatable").dataTable({
			...
			"iDisplayLength": 50,
			"sAjaxSource": root+'user_type/fetch_record/',
...
{
	main_delete(deleleid,'user_type/deleterecord','user_type')
}
...
$("#edit_pallet_cap").submit(function(event) {
	...
	$.ajax({
            type: "post",
            url: 	root+'user_type/update_record',
            data: postData,
			processData: false,
			contentType: false,
			cache: false,
     ...
     $.ajax({ 
              ...
              success: function (response) { 
				   ...
				   $("#myModal").modal({
					 ...
					 $("#eid").val(id);
					 $("#edit_user_type").val(obj.user_type);
			 	 	unblock_page("",""); 
                  }
