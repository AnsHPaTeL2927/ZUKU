    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">  Received RODTEP Payment </h4>
...
$("#recive_payment_form").submit(function(event) {
	...
	var postData= new FormData(this);
 	...
 	$.ajax({
            ...
            url: 	root+'rodtep_received/manage',
...

			    {
				   ...
				   $("#invoice_form").trigger('reset');
				    ...
				    unblock_page("success","Sucessfully Inserted.");
						...
						setTimeout(function(){ window.location=root+'rodtep_received'; },1500);
...

{
	...
	datatable = $("#datatable").dataTable({
			...
			"sAjaxSource": root+'rodtep_received/fetch_record/',
  ...
  confirmButtonText: 'Yes, delete it!'
		 ...
		 if (result.value) {
			...
			block_page();
              ...
              url: root+'rodtep_received/deleterecord',
