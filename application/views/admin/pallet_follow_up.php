			 ...
			 <div class="row">
			 	<div class="col-sm-12">
			 		<ol class="breadcrumb">
			 			...
			 			<li class="active">
			 				<a href="<?=base_url().'pallet_follow_up'?>">Pallet Follow Up</a>
			 			</li>
			 	 	</ol>
			 		...
			 		<div class="panel panel-default">
                         ...
                         <div class="">
							...
							<div class="col-md-4">
									  ...
									  <div class="table-responsive view_report" style="margin-top: 100px;"></div>
						   </div>
						 </div>
                     </div>
				 </div>
...
function view_fllow_up(performa_invoice_id,invoice_no)
{
	...
	datatable = $("#datatable1").dataTable({
			...
			"iDisplayLength": 50,
			"sAjaxSource": root+'pallet_follow_up/fetch_followup_record/',
...
$("#pi_follow_up").submit(function(event) {
	...
	postData.append("mode","add");
	 ...
	 var url = root+'pallet_follow_up/manage';
	$.ajax({
            type: "post",
            url: url,
            data: postData,
...
function add_fllow_up(production_mst_id,producation_no)
{
...
{ 	
	...
	$.ajax({          
		type: "POST",          
		url: root+'pallet_follow_up/view_report',         
		data: {          
