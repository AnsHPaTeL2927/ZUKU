									...
									<div class="pull-right form-group">
										 <div class="col-sm-5">
											<div class="dropdown">
												...
												<li> <a class="tooltips" data-toggle="tooltip" data-title="View Invoice (With Sign)" href="<?=base_url('exportinvoiceview/index_cnf/'.$invoicedata->export_invoice_id)?>" ><i class="fa fa-file-text-o"></i> View Invoice (CIF)</a>
												<li> <a class="tooltips" data-toggle="tooltip" data-title="View Invoice (With Sign)" href="<?=base_url('exportinvoiceview/index_kg/'.$invoicedata->export_invoice_id)?>" ><i class="fa fa-file-text-o"></i> View Invoice (KG)</a>
												</li>
		...
		?>
							<div class=" panel-default">
										...
										$rowspan = 0;
											...
											{	
											 	...
											 	if(!in_array(trim($productdata[$i]->series_name.'<br> HSN Code - '.$productdata[$i]->hsnc_code),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
															// if(empty($productdata[$i]->product_id)){
																// $Total_ammount	 += ($productdata[$i]->origanal_boxes * $productdata[$i]->product_rate);
															// } else {
															...
															// if(empty($productdata[$i]->product_id)){
																// $Total_amt	 += ($productdata[$i]->origanal_boxes * $productdata[$i]->product_rate);
															// } else {
							  ...
							  <table cellspacing="0" cellpadding="0" width="100%" class="pdf_class invoice_edit_cls" contenteditable="false">
											...
											<tr>
												<td colspan="4"  style="font-weight:bold;vertical-align: bottom;text-align: center;font-size:16px;background-color:#F2F2F2 ; color:#000000;">
												    EXPORT INVOICE
											  </td>
											</tr>
											<tr>
												<td colspan="4"  style="font-weight:bold;vertical-align: bottom;text-align: center;font-size:10;background-color:#F2F2F2 ; color:#000000;">
												<?php
											...
											<tr>
												<td colspan="2" style="font-weight:bold;border-bottom:none;background-color:#F2F2F2 ; color:#000000;">Exporter :</td>
												<td style="background-color:#F2F2F2 ; color:#000000;"><span style="font-weight:bold;">Exporter Invoice No. &amp; Date :</span> 
														 
												</td>
												
												<td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;">Exporter Reference 
											...
											<tr>
												 ...
												 <td ><strong> Buyer Order No & Date : </strong><?=$buy_order_no?></td>
											...
											<tr>
												 ...
												 <td colspan="2"><strong> LUT (ARN) AD2403250537156 DT:-24/03/2025 </strong></td>
											...
											<tr>
											  <td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;">  Pre Carriage By</td>
											  <td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;"> Place of Receipt by Pre-Carrier </td>
											  <td colspan="2" rowspan="4"  style="vertical-align:top;">
											  <P style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;"> BANK DETAILS </P>
											...
											<tr>
											    <td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;">Vessel /Flight No. </td>
													
												<td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;">Port Of Loading : - </td>
											...
											<tr>
												<td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;">
													Port Of Discharge
												</td>
												<td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;"> Final Destination </td>
												<td style="text-align:center;border-bottom:none;background-color:#F2F2F2 ; color:#000000;font-weight:bold;" colspan="2">Terms of Delivery & Payment </td>
											</tr>
											<tr>
												<td >
													 <?=$port_of_discharge?>
											...
											<tr>
											    <td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;">Country of Origin of Goods  </td>
												
												<td style="background-color:#F2F2F2 ; color:#000000;font-weight:bold;">Country of Final Destination</td>
							...
							<table  width="100%" cellspacing="0" cellpadding="0" class="pdf_class invoice_edit_cls1" contenteditable="false">
							  ...
							  <tr>
							    <td colspan="7" rowspan="2" valign="top" style="text-align:left"><strong><u>Declaration</u></strong>: <br />
							      ...
							      &nbsp;</td>
							    <td height="100" colspan="5" style="text-align:left;border-bottom:hidden" valign="top"><span style="border-bottom:hidden">For
							      <?=$company_detail[0]->s_name?>
							      </span></td>
						      </tr>
							  <tr>
														    ...
														    <tr>
															 ...
															 <tr>
															  ...
															  <tr>
																...
																<td colspan="4" style="border-bottom:none; border-top:none;" ><?=$Total_pallet?> Pallets (<?=$Total_box?>
BOXES)															 </td>
														     </tr>
															  <tr>
															    <td style="border-bottom:none;border-right:none;border-top:none;"></td>
