...
function view_pdf(no)
{
	if(no==1)
	{
	  ...
	  ?>
										<tr>
											<td style="text-align:center;font-weight:bold" colspan="13"> <?=implode(",",$hsn_array)?></td>
										</tr>
										<tr>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Size</td>
										   <td width="7%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Thikness</td>
										   <td width="7%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Name</td>
										   <td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Image</td>
										   <td width="8%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Finish</td>
										   <td width="8%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Boxes/Pallet	</td>
										   <td width="8%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Pallets	</td>
								...
								?>
									<tr>
										...
										<td style="text-align:center;border-bottom: none;border-right: none;"><?=(!empty($product_data[$i]->thickness))? $product_data[$i]->thickness.' MM':"";?> </td>
...
$Total_sqm 	+= $packing_row->no_of_sqm;										
								...
								?>
			 					 ...
			 					 <tr>
										<td colspan="6" style="text-align:right;font-weight:bold;border-bottom: none;border-right: none;">Total</td>
	...
	block_page();
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"performa_invoice_pdf"	: 'performa_invoice_with_thickness_pdf'
	   }, 
...
function edit_invoice()
{
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"invoice_table_name"	: 'performa_invoice_with_thickness_pdf'  
		}, 
       success: function (response)
	   {
			 unblock_page("success","invoice Updated"); 
