										...
										<span class="caret"></span></button>
											<ul class="dropdown-menu">
											 <li>
												...
												?>
													<a class="tooltips" data-toggle="tooltip" data-title="PI 2" href="<?=base_url('performa_invoice_pdf/index2/'.$invoicedata->performa_invoice_id)?>" ><i class="fa fa-file-text-o"></i> PI (Agent)</a>
