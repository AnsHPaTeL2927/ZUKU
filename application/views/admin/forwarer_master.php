				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							...
							<h3>
							Forwarer MASTER
								 <a href="<?php echo base_url('add_forwarer'); ?>" style="float:right;" type="button" class="btn btn-info">
								+ Forwarer  
								</a>
							 </h3>
						 ...
						 <div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									Forwarer MASTER
									<a href="#myModal" class="popup-btn pull-right" data-toggle="modal"><i class="fa fa-youtube"></i></a>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title">How To Manage Forwarer List</h4>
												</div>
												<div class="modal-body">
													<iframe id="cartoonVideo" width="560" height="315" src="https://www.youtube.com/embed/llTnN2qChmc?rel=0&autoplay=0"" frameborder="0" allowfullscreen></iframe>
												</div>
											</div>
										</div>
									</div>
															...
															<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Action
																<span class="caret"></span></button>
																	  <ul class="dropdown-menu">
																		<li>
																			<a class="tooltips" data-title="Edit" href="<?=base_url().'add_forwarer/form_edit/'.$result[$i]->id?>" ><i class="fa fa-pencil"></i>Edit</a>
																		</li>
																		...
																		<li>
																			<a class="tooltips" data-title="Edit" href="<?=base_url().'forwarer_contact_list/index/'.$result[$i]->id?>" ><i class="fa fa-plus"></i>Add Contact</a>
																		</li>
																		<li>
																			<a class="tooltips" data-title="Bank Details" id="bankmodal" data-toggle="modal" onclick="bank_data(<?=$result[$i]->id?>,<?=$result[$i]->bank_id?>)"><i class="fa fa-bank"></i>Bank Details</a>
																		</li>
...
<div id="myModal2" class="modal fade myModal2" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
			...
			<input type="hidden" name="forwarermaster" id="forwarermaster" value="1"/>
			
			<input type="hidden" name="eid" id="eid" value="<?=$forwarer_data->id?>" />
	 ...
	 $.ajax({
            ...
            success: function(responseData) {
			   ...
			   if(obj.res==1)
			   {
					...
					setTimeout(function(){ window.location=root+'forwarer_master'; },1500);
				}
				else  if(obj.res==2)
			   {
...
{
	main_delete(deleleid,'forwarer_master/deleterecord','forwarer_master')
}
