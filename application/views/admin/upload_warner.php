			...
			<div class="main-content">
				...
				<form class="form-horizontal askform col-md-offset-1" action="javascript:;"  method="post" name="ewb_form" id="ewb_form">
					...
					<div class="col-md-offset-2">
					 ...
					 <input type="hidden" id="api_key" name="api_key" value="<?=$warner_data->api_key?>"  />
					 <input type="hidden" id="latitude" name="latitude" value="<?=$warner_data->latitude?>"  />
					 <input type="hidden" id="longitude" name="longitude" value="<?=$warner_data->longitude?>"  />
					 <input type="hidden" id="warner_company_id" name="warner_company_id" value="<?=$warner_data->warner_company_id?>"  />
					 <input type="hidden" id="customer_id" name="customer_id" value="<?=$warner_data->customer_id?>"  />
					 <input type="hidden" id="enter_by" name="enter_by" value="<?=$warner_data->enter_by?>"  />
					 <input type="hidden" id="ebn_enter_type" name="ebn_enter_type" value="<?=$warner_data->ebn_enter_type?>"  />
					 <input type="hidden" id="exporter_iec" name="exporter_iec" value="<?=$exportinvoice_data->exporter_iec?>"  />
            ...
            success: function(responseData) {
               console.log(responseData);
					...
					if(obj.res == 1)
					{
						...
						setTimeout(function(){ window.location=root+'exportinvoice_listing/upload_warner/'+<?=$exportinvoice_data->export_invoice_id?>; },1500);
