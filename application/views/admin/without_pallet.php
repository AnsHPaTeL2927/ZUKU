											...
											<div class="dropdown">
												...
												<span class="caret"></span></button>
													<ul class="dropdown-menu">
														...
														<li>
															<a class="tooltips" data-toggle="tooltip" data-title="View Invoice" href="<?=base_url('With_thickness_Con/index/'.$invoicedata->export_invoice_id)?>" ><i class="fa fa-file-text-o"></i> With Thickness</a>
														</li>
														<li>
