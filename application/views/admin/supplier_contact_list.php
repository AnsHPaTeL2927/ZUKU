...
{
	main_delete(deleleid,'supplier_contact_list/deleterecord','supplier_contact_list/index/'+<?=$supplier_id?>)
}
$("#epcg_add").validate({
		rules: {
			epcg_no: {
            ...
            success: function(responseData) {
               console.log(responseData);
				...
				if(obj.res==1)
			    {
				   ...
				   setTimeout(function(){ window.location=root+'supplier_contact_list/index/'+<?=$supplier_id?> },1500);
				}
				else if(obj.res==2)
			    {
