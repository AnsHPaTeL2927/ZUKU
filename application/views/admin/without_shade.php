												...
												<span class="caret"></span></button>
													<ul class="dropdown-menu">
														<li>
													 	...
													 	<li>
															<a class="tooltips" data-toggle="tooltip" data-title="View Invoice (With Sign)" href="<?=base_url('Without_image_con/index/'.$invoicedata->export_invoice_id)?>" ><i class="fa fa-file-text-o"></i> Without Image</a>
														</li>
														<li>
