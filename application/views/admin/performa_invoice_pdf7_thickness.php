	...
	if(no==1)
	{
								...
								else
								{
									...
									<table cellspacing="0" border="1" cellpadding="0"  width="100%" class="main_table invoice_edit_cls">
										  ...
										  <td  width="100%" style="border-left: 0.1px solid;border-right:none;">
									        <img src="<?=base_url().'upload/'.$company_detail[0]->head_logo?>"  width="295px;" height="100px;"/>											
									        </td>
									    </tr>
										<tr>
									...
									<table cellspacing="0" cellpadding="0"  width="100%" class="main_table invoice_edit_cls" border="1" style="font-size:12px;">
									 	...
									 	<tr>
									 	  <td colspan="2"  style="border-right:none;border-bottom: none;" valign="top"><?=$export?>										  Exporter IEC code : <?=$company->s_iec?>										  </td>
								 	  </tr>
									 	<tr>
		...
		?><hr />
										...
										<tr>
										  ...
										  <td style="vertical-align:top;border-bottom:none"> <?=$invoicevalue_say?>, <?=$invoicedata->terms_of_delivery?></td>
									  </tr>
										<tr>
										  <td style="vertical-align:top;border-bottom:none"><strong>Payment Terms </strong></td>
										  <td style="vertical-align:top;border-bottom:none"> <?=$invoicedata->payment_terms?> &nbsp;</td>
									  </tr>
										 <tr>
										...
										<tr>
									      ...
									      <?php
												...
												if(!empty($invoicedata->container_forty))
												{
												 ...
												 ?></td>
										  <td colspan="4" style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">
							...
							//	echo implode(" & ",$seriesname_array).implode(" & ",$hsn_array);
								?>&nbsp;
										...
										<tr>
											<td width="5%" style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Sr No</td>
											<td  width="15%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Image</td>
											<td width="10%"  style="text-align:center;font-weight:bold;border-bottom: one;border-right: none;">Product Size (mm) & Description</td>
											<td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Name/ Code</td>
											<td width="5%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Product Client Name/ Code</td>
											<td width="10%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Finish/ Surface</td>
										    <td width="7%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Boxes / Pallet	</td>
										    <td width="6%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Pallets
										    </td>
										    <td width="6%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Total Boxes</td>
										    <td width="7%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Quantity</td>
												<td width="5%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Unit</td>
											<td width="5%"  style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;">Price (<?=strtoupper($invoicedata->currency_name)?>)</td>
									...
									<tr>
									  ...
									  <td style="text-align:center;border-right: none;">
										...
										<p style="margin: 0 auto; width:98px;height:95px;overflow:hidden">
											...
											?>
												<img src="<?=(!empty($packing_row->design_file))?DESIGN_PATH.$packing_row->design_file:DESIGN_PATH.'No-image-found.jpg'?>" style="width:90px"/> 
											<?php 
											}
											?>
											 </p>
									   ...
									   <?php 
											if($product_data[$i]->extra_product == 1)
											{
												...
												$total_qty += $total_product_sqmlm;
											?>
												<td colspan="4" style="text-align:center;border-right: none;"><?=$product_data[$i]->description_goods?></td>
										...
										<?=$product_data[$i]->series_name?><br>
										HSN-<?=$product_data[$i]->hsnc_code?>
								...
								<?php }  ?>
			 					 ...
			 					 <tr>
										...
										<td style="text-align:center;font-weight:bold;border-bottom: none;border-right: none;"> <?=$total_qty?> </td>
								 ...
								 ?>
								 <tr>
										<td colspan="2" style="text-align:right;border-bottom: none;border-right: none;font-weight:bold">TOTAL 
...
(IN WORDS)</td>
								 ...
								 <tr>
								   <td colspan="13" style="font-weight:bold;border-right:1px soild;font-size:12px"><strong>Bank Detail</strong></td>
								   </tr>
								 <tr>
								   <td colspan="6" style="border-right:1px soild;vertical-align:top;font-size:12px">
								    Name of company  :
                                     ...
                                     <br />
                                     Account No. :
<?=$invoicedata->account_no?> (USD Account)
                                     <br />
...
IBAN NO  : <?=$invoicedata->iban_no?>-->
								    ...
								    <td colspan="7" style="font-weight:bold;border-right:1px soild;text-align:center;vertical-align:top;">
								   <?php 
											...
											if(!empty($size_array[$p]))
											{
												...
												<tr>
													...
													<td style="text-align:center">
													 <img src="<?=base_url().'upload/box_design/'.$size_array[$size_array[$p]]['box_design_img']?>"   height="" width="55px;" />
													</td>
		...
		?>
		  ...
		  ?>
										...
										<td colspan="4" style="font-weight:bold;vertical-align:top;"> 
											For, <?=$invoicedata->c_companyname?><br>
								 ...
								 {
								 ?>
									 	<td colspan="5" style="font-weight:bold;vertical-align:top;text-align:right"> 
											 For, <?=$invoicedata->for_signature_name?><br>
											<img src="<?=base_url().'upload/user/'.$invoicedata->sign_image?>"  width="140px"   height="80px;">
											<br>
								...
								?>	
									<td colspan="5" style="font-weight:bold;vertical-align:top;text-align:right"> 
											...
											<img src="<?=base_url().'upload/'.$company->s_c_sign?>"  width="140px;" height="80px;">
											<br>
											<br>
								...
								?>
								 ...
								 <tr>
								   <td colspan="13" style="border-right:1px soild" valign="top"><strong>Declaration:</strong>  We declare that this Invoice shows the actual price of the goods described and that all particulars are true and correct. All legal matters are subject to Indian Juridiction
&nbsp;
<br>
<strong>CONTACT PERSON NAME: </strong>  <?=!empty($invoicedata->sign_pi_status)?$invoicedata->contact_person_name:$invoicedata->contactperson_name?>, <strong>CONTACT NUMBER: </strong><?=!empty($invoicedata->sign_pi_status)?$invoicedata->contact_no:$invoicedata->e_mobile?>, <strong>EMAIL: </strong><?=!empty($invoicedata->sign_pi_status)?$invoicedata->contact_email:$invoicedata->e_email?><br><br><br><strong>COMPANY DETAIL: </strong> <br> <strong>EMAIL: </strong><?=$company_detail[0]->s_email?>, <strong>WEBSITE: </strong><?=$company_detail[0]->website?>
	...
	block_page();
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"performa_invoice_pdf"	: 'performa_invoice_pdf7'
	   }, 
...
function edit_invoice()
{
     ...
     $.ajax({ 
       ...
       data:
	   {
			...
			"invoice_table_name"	: 'performa_invoice_pdf7'  
		}, 
       success: function (response)
	   {
			 unblock_page("success","invoice Updated"); 
