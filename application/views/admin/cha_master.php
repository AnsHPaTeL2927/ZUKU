										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title">How To Manage CHA List</h4>
												</div>
												<div class="modal-body">
													<iframe id="cartoonVideo" width="560" height="315" src="https://www.youtube.com/embed/-Tku9xw4YA8?rel=0&autoplay=0"" frameborder="0" allowfullscreen></iframe>
												</div>
											</div>
										</div>
									</div>
															...
															<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Action
																<span class="caret"></span></button>
																	  <ul class="dropdown-menu">
																		<li>
																			<a class="tooltips" data-title="Edit" href="<?=base_url().'add_cha/form_edit/'.$result[$i]->id?>" ><i class="fa fa-pencil"></i>Edit</a>
																		</li>
																		...
																		<li>
																			<a class="tooltips" data-title="Edit" href="<?=base_url().'supplier_contact_list/index/'.$result[$i]->id?>" ><i class="fa fa-plus"></i>Add Contact</a>
																		</li>
																		<li>
...
<div id="myModal2" class="modal fade myModal2" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
			...
			<input type="hidden" name="chamaster" id="chamaster" value="1"/>
