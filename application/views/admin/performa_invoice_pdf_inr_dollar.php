...
<tr>
    ...
    <td width="8%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">SIZE</td>
    ...
    <td width="7%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">BOXES / PALLET</td>
    <td width="8%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">CONTAINER</td>
    <td width="6%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">PALLETS</td>
    <td width="5%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">TOTAL BOXES</td>
    <td width="7%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">QUANTITY (<?= $invoicedata->per_value ?>)</td>
    <td width="7%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">WEIGHT</td>
    <td width="8%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">RATE / <?= $invoicedata->per_value ?> (<?= strtoupper($invoicedata->currency_name) ?>)</td>
    <td width="9%" style="background-color:#F2F2F2; color:#000000;text-align:center;font-weight:bold;font-size:8PX;">AMOUNT (<?= strtoupper($invoicedata->currency_name) ?>)</td>
</tr>
