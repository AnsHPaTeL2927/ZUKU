	 ...
	 $.ajax({
            ...
            success: function(responseData) {
			   ...
			   if(obj.res==1)
			   {
					...
					setTimeout(function(){ window.location=root+'add_forwarer'; },1500);
				}
				else  if(obj.res==2)
			   {
...
{
	main_delete(deleleid,'forwarer_contact_list/deleterecord','add_forwarer/form_edit/<?=$edit_record->id?>')
}
$("#epcg_add").validate({
		rules: {
			epcg_no: {
            ...
            success: function(responseData) {
               console.log(responseData);
				...
				if(obj.res==1)
			    {
				   ...
				   setTimeout(function(){ window.location=root+'add_forwarer/form_edit/<?=$edit_record->id?>'; },1500);
				}
				else if(obj.res==2)
			    {
