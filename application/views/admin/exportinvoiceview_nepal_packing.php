												...
												if(!in_array(trim($product_data[$i]->series_name.'<br> HSN Code - '.$product_data[$i]->hsnc_code),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
													...
													if(!in_array(trim($description_goods),$product_desc_array))
													{
														...
														$product_desc_array[trim($description_goods)]['net_weight'] = $product_data[$i]->total_ori_net_weight;
														$product_desc_array[trim($description_goods)]['gross_weight'] = $product_data[$i]->total_ori_gross_weight;
														$product_desc_array[trim($description_goods)]['totalnetweight'] = $product_data[$i]->total_ori_net_weight;
														$product_desc_array[trim($description_goods)]['totalgrossweight'] = $product_data[$i]->total_ori_gross_weight;
            ...
            <div class="profile-pic" style="margin-top:80px;">
              ...
              <div class="save_invoice_html">
                ...
                <table  width="100%" cellspacing="0" cellpadding="0" style="padding:5px" class="pdf_class invoice_edit_cls" contenteditable="false">
				  ...
				  <tr>
                    <td colspan="2" style="text-align:center;font-weight:bold">DETAILS</td>
                  ...
                  <tr>
                    ...
                    <?php
													  ...
													  ?>
					<td colspan="2" style="text-align:center" ><?=$product_desc_array[$product_desc_array[$p]]['series_name']?></td>
                    ...
                    <td style="text-align:center">
                      <?=$product_desc_array[$product_desc_array[$p]]['net_weight']?></td>
                    <td style="text-align:center"><span style="text-align:center">
                    <?=$product_desc_array[$product_desc_array[$p]]['gross_weight']?>
                      </span></td>
                  </tr>
                  <?php
                ...
                <!--  <tr>
                  ...
                  <tr>
                    <td rowspan="2" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;text-align:center" colspan="2"> 
						NO. & KIND OF PKGS <br> <?=$Total_box; ?> 	BOXES
					</td>
                  <td  colspan="4" rowspan="2" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center;" ><span style="font-weight:bold;vertical-align:top;text-align:center">TOTAL<strong> </strong></span></td>
				   <td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center;">
                    ...
                    <td   style="border-right:0.5px solid #333;border-top:0.5px solid #333;text-align:center;font-weight:bold;"><span style="text-align:center"> <?=number_format($totalnetweight,2,'.',''); ?></span></td>
                    <td  style="border-top:0.5px solid #333;font-weight:bold;text-align:center"><span style="text-align:center"><?=number_format($totalgrossweight,2,'.',''); ?></span></td>
                  </tr>
                  <tr>
                    ...
                    <td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;text-align:center;font-weight:bold;">KGS</td>
