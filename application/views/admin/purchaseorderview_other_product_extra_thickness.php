					...
					<div class="row">
						<div class="col-sm-12">
										...
										<table cellspacing="0" cellpadding="0"    width="100%">
											<tr>
												<td style="padding:0;border-top:none;border-bottom:none" colspan="8">
														<img src="<?=base_url().'upload/'.$company_detail[0]->head_logo?>" height="180px" />
												</td>
										 	</tr> 
											<tr>
												...
												<td rowspan="3" colspan="2" style="padding: 5px; margin: 0; vertical-align: top;font-weight:bold">
													 ...
													 GSTIN : <?=$s_gst?> <br> 
													 Contact no : +919727190633<br>
													 Email : int.export@bluetoneceramic.com
												</td>
												 ...
												 ?>
													<tr>
														...
														<td style="text-align:right">
															<img src="<?=base_url().'adminast/assets/images/ruppe_sysbol.jpg'?>" /> 
															<?=indian_number($product_desc_array[$product_desc_array[$p]]['amount'],2)?>
														</td>
													</tr>
															<?php
								...
								{ 
							 	  ...
							 	  foreach($jsonalldata->packing  as $packing_row)
								  {
									  ...
									  <tr> 
											...
											<td style="text-align:center">
												<p style="margin: 0 auto; width:98px;height:85px;overflow:hidden">
							...
							<tr>
								...
								<th style="text-align:center">Sqm per box</th>
									...
									$box_design_name = '';
										...
										for($p=0;$p<count($size_array);$p++)
										{
											...
											if(!empty($size_array[$p]))
											{
												...
												<tr>
													...
													<img src="<?=base_url().'upload/box_design/'.$size_array[$size_array[$p]]['box_design_img']?>" style="width:100px;margin: auto; top: 0px; left: 0; right: 0; bottom: 0; position: absolute;"/>
													 </p>
										...
										<td style="vertical-align:top;">
											...
											if(!empty($images_name[0]) && $images_name[0] != "none")
											{
												...
												echo "<div style='margin-bottom:5px'>
														<img src='".base_url()."upload/".$img."'  height='50px' width='250px'/> 
													  </div>"; 
										...
										if(!empty($invoicedata->box_sticker_file) && $invoicedata->box_sticker_file != "none")
										{
											?>
													...
													<img src='<?=base_url()."upload/".$invoicedata->box_sticker_file?>' width='290px' height='100px'/>
