    ...
    <td class="whitebg pad15">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="270" align="left" valign="middle" class="font-12 dark-bg dbg-text-color pad10"><span>Inward Po No : <?=$invoicedata->export_ref_no?></span><br>
            IEC Code: 
              <?=$company->s_iec?>
              <br>
            GSTIN No: 
...
?></td>
      ...
      <table class="font-12" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="1%" align="left" valign="middle"></td>
          <td width="10" align="center" valign="middle" class="dark-bg font-bold dbg-text-color font-13 pad5">Qty Sqft. </td>
          <td width="1%" align="left" valign="middle"></td>
          <td width="10" align="center" valign="middle" class="dark-bg font-bold dbg-text-color font-13 pad5">Price Sqft.</td>
          <td width="1%" align="left" valign="middle"></td>
		...
		<?php 
								...
								{ 
								    ...
								    {
										$Total_sqf 	+= ($product_data[$i]->feet_per_box * $packing_row->no_of_boxes);
          ...
          <td align="center" valign="middle" class="greybg2 font-bold pad5">
			<?=number_format(($product_data[$i]->feet_per_box * $packing_row->no_of_boxes),2,'.',',')?>
		 </td>
      ...
      <table class="font-12" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="right" valign="top" width="600"><table class="font-13" width="100%" border="0" cellspacing="0" cellpadding="0">
			
			  
			 <tr>
			 <td width="100" align="center" valign="middle" class="greybg1 font-bold pad5">Total Boxes :  <?=$Total_box?></td>
			   
				    <td width="2" align="left" valign="middle"></td> 
					
			<td width="100" align="center" valign="middle" class="greybg1 font-bold pad5">Total SQF :  <?=number_format($Total_sqf,2,'.',',')?></td>
			   
				    <td width="2" align="left" valign="middle"></td>
					
			  <td width="100" align="center" valign="middle" class="greybg1 font-bold pad5">Total Pallets :  <?=$Total_plts?></td>
              ...
              <tr>
			   <td colspan="2"></td> <td colspan="2"></td> <td colspan="2"></td>
                <td align="center" valign="middle" class="dark-bg font-bold pad5 dbg-text-color">Total Ex-Factory Amount </td>
                <td align="left" valign="middle"></td>
