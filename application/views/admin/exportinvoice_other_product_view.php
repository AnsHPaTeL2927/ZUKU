<?php 
 ...
 $exporter_iec 				= $invoicedata->exporter_iec;   $exporter_state_code		= $company_detail[0]->state_code; 
				...
				<div class="container">
											...
											<div class="dropdown">
												...
												<span class="caret"></span></button>
													<ul class="dropdown-menu">
														<li>
															<a class="tooltips" data-toggle="tooltip" data-title="View Invoice" href="<?=base_url('exportinvoiceview/index/'.$invoicedata->export_invoice_id)?>" ><i class="fa fa-file-text-o"></i> View Invoice </a>
														</li> 
														<li>
					...
					<div class="row">
						<div class="col-sm-12">
											...
											{	
											 	...
											 	if(!in_array(trim($product_data[$i]->series_name.'<br> HSN Code - '.$product_data[$i]->hsnc_code),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
													...
													$Total_amt 	 	 += ($product_data[$i]->product_rate * $qty);
													
													$description_goods =  $product_data[$i]->description_goods.$product_data[$i]->pcs_per_box.$product_data[$i]->product_rate.$product_data[$i]->origanal_boxes;
												 	...
												 	if(!in_array(trim($description_goods),$product_desc_array))
													{
														...
														{ 
															$product_desc_array[trim($description_goods)]['sqm'] = ($product_data[$i]->origanal_sqm);
														}
														else
														{
													...
													if($product_data[$i]->product_id == 0)
													{
														...
														{
															$Total_qty 	+= $product_data[$i]->origanal_sqm;
														}
														else
														{
															$Total_qty 	+= $product_data[$i]->origanal_boxes;
														}
													}
							...
							?>
							  ...
							  <div class="profile-pic">
								...
								{
									?>
													  <table cellspacing="0" cellpadding="0" width="100%" class="pdf_class invoice_edit_cls" contenteditable="false">											  											<tr>												<td width="25%" style="padding:0px;border:none;"></td>												<td width="25%" style="padding:0px;border:none;"></td>												<td width="25%" style="padding:0px;border:none;"></td>												<td width="25%" style="padding:0px;border:none;"></td>												 										 	</tr>  											<tr>												<td colspan="4"  style="font-weight:bold;vertical-align: bottom;text-align: center;font-size:16px;">												    EXPORT INVOICE											  </td>											</tr>											<tr>												<td colspan="4"  style="font-weight:bold;vertical-align: bottom;text-align: center;font-size:10;">												<?php													if($invoicedata->igst_status==1)													{													?>													SUPPLY MEANT FOR EXPORT UNDER TACKING BOND WITHOUT PAYMENT OF INTERGRATED TAX (IGST)													<?php }													else{?>																												SUPPLY MEANT FOR EXPORT UNDER TACKING BOND WITH PAYMENT OF INTERGRATED TAX (IGST)													<?php }?>												</td>											</tr>											<tr>												<td colspan="2" style="font-weight:bold;border-bottom:none">Exporter :</td>												<td><span style="font-weight:bold">Exporter Invoice No. &amp; Date :</span> 														 												</td>																								<td>IEC NUMBER																								</td>											</tr>											<tr>												<td rowspan="5" colspan="2" style="vertical-align:top;border-right:none;border-top:none"> 												 <?=$export?></td>												 <td><?=$exportinvoice_no?></td>												 <td><?=$exporter_iec?></td>											</tr>											<tr>												 												 <td><strong> DT. <?=$export_date?></strong></td>												 <td> <strong>STATE CODE :<?=$exporter_state_code?></strong></td>											</tr>											<tr>												 												 <td> <strong>GST No :  												     <?=$exporter_gstin?></strong></td>												 <td> <strong>MASTER NO : <?=$consign_name?></strong></td>												 											</tr>											<tr>												 												 <td colspan="2"> PI No. &amp; Date : 												    <strong> <?=$export_ref_no?>&amp;<?=$performa_date?></strong></td>												 											</tr>																						<tr>												 													<td colspan="2">Buyer Order No & Date :												     <strong> <?=$buy_order_no?></strong></td>												 											</tr>												  										 	<tr>												<td colspan="2" valign="top">  <strong>Consignee : </strong><br>												<?=$consign_address?>												</td>												<td colspan="2" valign="top"><strong>Buyer's if other than Consignee (Notify Party):</strong> <br />												  <span style="vertical-align:top">											      <?=$buyer_other_consign?>										        </span></td>										 	</tr>											<tr>											  <td>  Pre Carriage By</td>											  <td> Place of Receipt by Pre-Carrier </td>											  <td colspan="2" rowspan="4"  style="vertical-align:top">											   Bank Details 												<br />                                                    <?=$bank_detail?>											 	</td>										</tr>											 											 <tr>											 												<td>													<?=!empty($pre_carriage_by)?$pre_carriage_by:'&nbsp;'?>												</td>												<td>													<?=$place_of_receipt?>												</td>											</tr>											<tr>											    <td>Vessel /Flight No. </td>																									<td>Port Of Loading : - </td>																							  </tr>											   <tr>											 												<td>												<?=!empty($flight_name_no)?$flight_name_no:'&nbsp;'?> 												</td>												<td>													<?=$export_port_loading?>												</td>											</tr>											<tr>												<td>													Port Of Discharge												</td>												<td> Final Destination </td>												<td style="text-align:center;border-bottom:none" colspan="2">Terms of Delivery & Payment </td>											</tr>											<tr>												<td style="font-weight:bold">													 <?=$port_of_discharge?>												</td>												<td style="font-weight:bold"> 													<?=$final_destination?>												</td>												<td style="font-weight:bold;vertical-align:top;text-align:center;border-top:none" colspan="2" rowspan="3">													<?=$invoicedata->terms_name?>													-												<?=$export_terms_of_delivery?>												<br>												PAYMENT : <?=$export_payment_terms?> 																																				</td>											</tr>											<tr>											    <td>Country of Origin of Goods  </td>																								<td>Country of Final Destination</td>																							  </tr>											  <tr>											    <td style="font-weight:bold"><?=!empty($country_origin_goods)?$country_origin_goods:'&nbsp;'?> </td>																									<td style="font-weight:bold"><?=!empty($country_final_destination)?$country_final_destination:'&nbsp;'?></td>																							  </tr>											  											   						      </table>
										<table  width="100%" cellspacing="0" cellpadding="0" style="padding:5px" class="pdf_class invoice_edit_cls" contenteditable="false">
											<tr>
												...
												<td style="padding:0;border-top:none;border-bottom:none" width="40%"></td>
												<td style="padding:0;border-top:none;border-bottom:none" width="10%"></td>
												<td style="padding:0;border-top:none;border-bottom:none" width="10%"></td>
												<td style="padding:0;border-top:none;border-bottom:none" width="10%"></td>
												<td style="padding:0;border-top:none;border-bottom:none" width="10%"></td>
										 	...
										 	<?php
												...
												<?php 
													...
													<td rowspan="<?=$rowspan?>" style="text-align:center;border-bottom:hidden"><?php
													  ...
													  <?=$Total_qty?>
													  <span style="text-align:center;font-weight:bold"> QUANTITY</span>													  													  <br>													  	<strong>Net Weight</strong> : <?=number_format($totalnetweight,2)?> KGS												<br>													<strong>Gross Weight</strong> : <?=number_format($totalgrossweight,2)?> KGS 													  </td>													  												
													<?php
													  ...
													  ?>
															...
															<td style="text-align:center"><?= ($per == 'BOX') ? 'BAG' : $per ?></td>
															<td style="text-align:center">
																<?=$currency_symbol?>
																<?=number_format($product_rate,2)?>
															</td>
															<td style="text-align:center">
																<span style="text-align:center">
																<?=$currency_symbol?>
																<?=number_format(($product_rate * $qty),2,'.','')?>
																</span>
															</td>
									 	...
									 	$no++;
											...
											<tr>
															...
															<td style="font-weight:bold;text-align:center;border-bottom:hidden" colspan="2"> Sample
															</td>
													 		<td style="text-align:center;border-bottom:hidden"></td>
													 		<td style="text-align:center;border-bottom:hidden"></td>
													 		<td style="text-align:center;border-bottom:hidden"></td>
											...
											?>
													<tr>
														<td style="border-right:0.5px solid #333;text-align:center;">
													 	...
													 	<td style="border-right:0.5px solid #333;text-align:center" colspan="2">
															<?=$jsondata->product_size_id?> - <?=$jsondata->sample_remarks?> 
														</td>
													 	 
													 	<td  style="border-right:0.5px solid #333;text-align:center">
															<?=(!empty($jsondata->no_of_pallet))?$jsondata->no_of_pallet." PALLETS<br>":""?>
															<?=(!empty($jsondata->no_of_boxes))?$jsondata->no_of_boxes." BOXES<br>":""?>
															<?=(!empty($jsondata->sqm))?$jsondata->sqm." SQM<br>":""?>
														</td>
														<td  style="border-right:0.5px solid #333;text-align:center">
															<?=$jsondata->sample_per?>
														</td>
											...
											{ 
											 ?>
												<!--<tr>
														<td style="border:none;border-right:0.5px solid #333;border-left:0.5px solid #333;">
															&nbsp;  
														</td>
										...
										?>										
										 ...
										 <tr>
											<td colspan="3"  bgcolor="#ffffff" style="font-weight:bold;vertical-align:middle; text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;">
												
												<span style="color: #000000;">THE GOODS EXPORT UNDER LETTER OF UNDERTAKING(LUT)  :  <?=$invoicedata->lut_no?>
                      ...
                      <?php }  ?>
											...
											<!--	<td  style="font-weight:bold;text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;"> TOTAL QUANTITY </td>-->
											
										
											<td  style="font-weight:bold;text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;"><?=($Total_qty == 0)?"-":$Total_qty; ?></td>
											<td  style="font-weight:bold;text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;"></td>
									
									 	   
											<td   style="font-weight:bold; text-align:center; color:#000;border-top:0.5px solid #333;border-right:0.5px solid #333;"><?=($invoicedata->calculation_operator == 2)? $invoicedata->terms_name: 'FOB';?>
&nbsp;Value </td>
										  	<td     style="font-weight:bold;text-align:right;color:black;border-top:0.5px solid #333;"><?=$currency_symbol?><?=number_format($Total_amt,2,'.',''); ?></td>
										 </tr>
										...
										$Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->certification_charge:$Total_amt + $invoicedata->certification_charge;  ?>
										  <tr>
												<!--<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;text-align:center" colspan="3"> -->
												<!--<span style="font-weight:bold;vertical-align:top;text-align:center">Exchange Rate  <strong>-->
												<!--  <?=!empty($invoicedata->notification_text)?"(".$invoicedata->notification_text.")":""?>-->
												<!-- </strong></span>	 -->
												<!--</td>-->
												 
												<!--<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center;"><span style="font-weight:bold;vertical-align:top;text-align:center">-->
												<!--  <?=number_format($invoicedata->Exchange_Rate_val,2)?>-->
												<!--</span></td>-->
												<!--<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center;"></td>-->
										...
										$Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->certification_charge:$Total_amt + $invoicedata->certification_charge;  ?>
										 ...
										 <?php  $Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->seafright_charge:$Total_amt + $invoicedata->seafright_charge; 
										  ...
										  <?php $Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->discount:$Total_amt + $invoicedata->discount;  ?>
										  <?php 
										 ...
										 <tr>
										  ...
										  <tr>
										   ...
										   <td rowspan="2"   style="border-right:0.5px solid #333;text-align:center"> 
...
(1) Certified That The Description &amp; Value Of Goods Covered By This Invoice Have Been Checked By Me &amp; That Goods Have Been Packed &amp; Sealed With One Time Seal (OTS) Under My Direct Supervision 
										...
										<tr>
											<td style="border-right:0.5px solid #333;border:0.5px solid #333;" colspan="4">
					 ...
					 <div class="profile-pic">
								...
								{
									?>
						  <table cellspacing="0" cellpadding="0" width="100%"  class="pdf_class invoice_edit_cls1" contenteditable="false">											<tr>												<td style="padding:0;border:none" colspan="4">														 												</td>										 	</tr>  											<tr>												<td width="25%" style="padding:0;border:none;"></td>												<td width="25%" style="padding:0;border:none;"></td>												<td width="25%" style="padding:0;border:none;"></td>												<td width="25%" style="padding:0;border:none;"></td>												 										 	</tr>  											<tr>												<td colspan="4"  style="font-weight:bold;vertical-align: bottom;text-align: center;font-size:16px;">												    PACKING LIST											  </td>											</tr>											<tr>												<td colspan="4"  style="font-weight:bold;vertical-align: bottom;text-align: center;font-size:10;">												<?php													if($invoicedata->igst_status==1)													{													?>													SUPPLY MEANT FOR EXPORT UNDER TACKING BOND WITHOUT PAYMENT OF INTERGRATED TAX (IGST)													<?php }													else{?>																												SUPPLY MEANT FOR EXPORT UNDER TACKING BOND WITH PAYMENT OF INTERGRATED TAX (IGST)													<?php }?>												</td>											</tr>											<tr>												<td colspan="2" style="font-weight:bold;border-bottom:none">Exporter :</td>												<td><span style="font-weight:bold">Exporter Invoice No. &amp; Date :</span> 														 												</td>																								<td>IEC NUMBER																								</td>											</tr>											<tr>												<td rowspan="5" colspan="2" style="vertical-align:top;border-right:none;border-top:none"> 												 <?=$export?></td>												 <td><?=$exportinvoice_no?></td>												 <td><?=$exporter_iec?></td>											</tr>											<tr>												 												 <td><strong> DT. <?=$export_date?></strong></td>												 <td> <strong>STATE CODE :<?=$exporter_state_code?></strong></td>											</tr>											<tr>												 												 <td> <strong>GST No :  												     <?=$exporter_gstin?></strong></td>												 <td> <strong>MASTER NO : <?=$consign_name?></strong></td>												 											</tr>											<tr>												 												 <td colspan="2"> PI No. &amp; Date : 												    <strong> <?=$export_ref_no?>&amp;<?=$performa_date?></strong></td>												 											</tr>											<tr>												 													<td colspan="2">Buyer Order No & Date :												     <strong> <?=$buy_order_no?></strong></td>												 											</tr>												  										 	<tr>												<td colspan="2" valign="top">  <strong>Consignee : </strong><br>												<?=$consign_address?>												</td>												<td colspan="2" valign="top"><strong>Buyer's if other than Consignee (Notify Party):</strong> <br />												  <span style="vertical-align:top">											      <?=$buyer_other_consign?>										        </span></td>										 	</tr>											<tr>											  <td>  Pre Carriage By</td>											  <td> Place of Receipt by Pre-Carrier </td>											  <td colspan="2" rowspan="4"  style="vertical-align:top">											   Bank Details 												<br />                                                    <?=$bank_detail?>											 	</td>										</tr>											 											 <tr>											 												<td>													<?=!empty($pre_carriage_by)?$pre_carriage_by:'&nbsp;'?>												</td>												<td>													<?=$place_of_receipt?>												</td>											</tr>											<tr>											    <td>Vessel /Flight No. </td>																									<td>Port Of Loading : - </td>																							  </tr>											   <tr>											 												<td>												<?=!empty($flight_name_no)?$flight_name_no:'&nbsp;'?> 												</td>												<td>													<?=$export_port_loading?>												</td>											</tr>											<tr>												<td>													Port Of Discharge												</td>												<td> Final Destination </td>												<td style="text-align:center;border-bottom:none" colspan="2">Terms of Delivery & Payment </td>											</tr>											<tr>												<td style="font-weight:bold">													 <?=$port_of_discharge?>												</td>												<td style="font-weight:bold"> 													<?=$final_destination?>												</td>												<td style="font-weight:bold;vertical-align:top;text-align:center;border-top:none" colspan="2" rowspan="3">													<?=$invoicedata->terms_name?>													-												<?=$export_terms_of_delivery?>												<br>												PAYMENT : <?=$export_payment_terms?> 																																				</td>											</tr>											<tr>											    <td>Country of Origin of Goods  </td>																								<td>Country of Final Destination</td>																							  </tr>											  <tr>											    <td style="font-weight:bold"><?=!empty($country_origin_goods)?$country_origin_goods:'&nbsp;'?> </td>																									<td style="font-weight:bold"><?=!empty($country_final_destination)?$country_final_destination:'&nbsp;'?></td>																							  </tr>											  											   						      </table>
											...
											<tr>
										 	...
										 	<?php
												...
												<?php 
													  ...
													  <?=$Total_qty?>
													  <span style="text-align:center;font-weight:bold"> BAG</span>			  </td>
													...
													<?php
													  ...
													  ?>
															...
															$qty = 0;
															if($product_desc_array[$product_desc_array[$p]]['per'] == "SQF")
															{
																$qty =  $product_desc_array[$product_desc_array[$p]]['boxes'];
															}
															else if($product_desc_array[$product_desc_array[$p]]['per'] == "BOX")
															{
																$qty =  $product_desc_array[$product_desc_array[$p]]['boxes'];
															}
															else if($product_desc_array[$product_desc_array[$p]]['per'] == "SQM")
															{
																$qty =  $product_desc_array[$product_desc_array[$p]]['sqm'];
														 	}
															else if($product_desc_array[$product_desc_array[$p]]['per'] == "PCS")
															{
																$qty =  $product_desc_array[$product_desc_array[$p]]['boxes'];
														 ...
														 ?>
																															...
																															<td style="text-align:center"><?= ($product_desc_array[$product_desc_array[$p]]['per'] == 'BOX') ? 'BAG' : $product_desc_array[$product_desc_array[$p]]['per'] ?></td>
													...
													<tr>
												 	  ...
												 	  <td  style="text-align:center">
														<?=(!empty($jsondata->no_of_pallet))?$jsondata->no_of_pallet." PALLETS<br>":""?>
													 	...
													 	<td  style="text-align:center"><?=$jsondata->sample_per?></td>
											 	 	</tr>
							...
							<table  width="100%" cellspacing="0" cellpadding="0" style="border:none" class="pdf_class invoice_edit_cls1" contenteditable="false">
							  ...
							  <tr>
							   <td style="text-align:center;font-weight:bold"> SR NO.</td>
							    ...
							    <td style="text-align:center;font-weight:bold">BAG NO.</td>
							    <td style="text-align:center;font-weight:bold"  colspan="2">PRODUCT</td>
							  ...
							  <?php
															...
															if(empty($sample_str))
															{
																...
																foreach($product_data[$i]->sample  as $sample_row)
																{
																	 $rowcon_no++;
																		...
																		$sample_pallet = (!empty($jsondata->no_of_pallet))?$jsondata->no_of_pallet." PALLETS<br>":"";
																		$sample_box =  (!empty($jsondata->no_of_boxes))?$jsondata->no_of_boxes." BOXES<br>":"";
																		$sample_sqm = (!empty($jsondata->sqm))?$jsondata->sqm." SQM<br>":"";
								...
								$n++;
												...
												?>
																						<td style="text-align:center"><?= ($product_data[$i]->per == 'BOX') ? 'BAG' : $product_data[$i]->per ?></td>												
											 	<td style="text-align:center" ><?=$qty?></td>
												<?php
														    ...
														    <tr>
															 ...
															 <tr>
															  ...
															  <tr>
																...
																<td colspan="4" style="border-bottom:none; border-top:none;"><?=$Total_qty?> Packages (<?=$Total_qty?>
BAG)															 </td>
														     </tr>
															  <tr>
															    <td style="border-bottom:none;border-right:none;border-top:none;"></td>
													 ...
													 <tr>
													  ...
													  <tr>
													    ...
													    <td style="text-align:center;font-weight:bold">LINE SEAL </td>
													     <td style="text-align:center;font-weight:bold"> BAG NO </td>
														  <td style="text-align:center;font-weight:bold">BAGS</td>
							  ...
							  <table width="100%"  cellspacing="0" cellpadding="0" class="pdf_class invoice_edit_cls2" contenteditable="false">		 
										...
										<tr>
												...
												<td width="30%" style="border:none;"><strong><?php if($no==1)
												{
													?>Self-Sealing Permission No. & Date<?php
												}
												?></strong></td>
												<td width="65%" style="border-bottom:none;border-left:none;border-top:none;">
												 <?php if($sup_row->permission_file_no!='')
													{
													?>
														 <strong><?=$sup_row->company_name?></strong>  Permission No. : <?=$sup_row->permission_no?>, Date : <?=date('d/m/Y',strtotime($sup_row->permission_date))?>
														 <?php } ?>
												 </td>
								   ...
								   <tr>
									   ...
									   <td style="border-bottom:none;border-left:none;border-top:none;" colspan="2">
									    EXPORT UNDER GST CIRCULAR No.: <?=$company_detail[0]->gst_circular_no?>, CUSTOM DATED : <?=$company_detail[0]->date_of_filing?> </td>
											...
											<tr>
											  <td style="border-bottom:none;border-right:none;border-top:none;text-align:center"></td>
											  <td colspan="2" bgcolor="#ffffff" style="border-bottom:none;border-left:hidden; border-top:none;color: #000;"><span style="color: #000000;">THE GOODS EXPORT UNDER LETTER OF UNDERTAKING(LUT)  :<span style="vertical-align:top; border-right:none; color: #000000;">
