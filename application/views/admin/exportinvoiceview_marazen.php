											 	...
											 	if(!in_array(trim($product_data[$i]->series_name.'<br> HSN Code - '.$product_data[$i]->hsnc_code),$series_name_array))
												{
											  	 ...
											  	 $n = 1;
												 	...
												 	if(!in_array(trim($description_goods),$product_desc_array))
													{
														...
														$product_desc_array[trim($description_goods)]['company_name'] = $product_data[$i]->company_name;
								...
								else
								{
									?>
										<table cellspacing="0" cellpadding="0" width="100%" class="pdf_class invoice_edit_cls" contenteditable="false">
											...
											<tr>
												<td rowspan="2" style="vertical-align:top;border-right:none"> 
													<?=$export?>
												</td>
												<td  rowspan="2" style="vertical-align:top;border-left:none">
					 ...
					 <br>
                      ...
                      <?php 
										...
										<table  width="100%" cellspacing="0" cellpadding="0" style="padding:5px" class="pdf_class invoice_edit_cls" contenteditable="false">
											...
											<tr>
												<td rowspan="2" style="text-align:center;font-weight:bold">SHIPPING MARKS &amp; NOS.</td>
												 ...
												 <td  rowspan="2" style="text-align:center;font-weight:bold">FACTORY NAME</td>
										 	...
										 	<?php
												...
												<?php 
													...
													<td rowspan="<?=$rowspan?>" style="text-align:center;border-bottom:hidden"><?php
													  ...
													  <?=$Total_qty?>
													  <span style="text-align:center;font-weight:bold"> QUANTITY</span></td>
													<?php
													  ...
													  ?>
															...
															<?php
															echo $product_desc_array[$product_desc_array[$p]]['company_name'];
															?>
															</td>
										...
										?>										
										 ...
										 <tr>
											<td colspan="4"  bgcolor="#000000" style="font-weight:bold;vertical-align:middle; text-align:center;border-top:0.5px solid #333;border-right:0.5px solid #333;">
												
												<span style="color: #FFF;">THE GOODS EXPORT UNDER LETTER OF UNDERTAKING(LUT)  :  <?=$invoicedata->lut_no?>
...
&nbsp;Value </td>
										  	<td  style="font-weight:bold;text-align:right;color:black;border-top:0.5px solid #333;"><?=$currency_symbol?><?=number_format($Total_ammount,2,'.',''); ?></td>
										 </tr>
									  	 <tr>
...
&nbsp;in INR </td>
												...
												<?=number_format($invoicedata->indian_ruppe_val,2,'.','')?></td>
												<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center;" colspan="2"><span style="font-weight:bold;vertical-align:top;text-align:center">
												  <?=($invoicedata->calculation_operator == 1)? $invoicedata->terms_name: 'FOB';?>
&nbsp;in  <?=$invoicedata->currency_name?>
                                                </span></td>
										 ...
										 <?php $Total_amt =($invoicedata->calculation_operator == 2)?$Total_amt - $invoicedata->insurance_charge:$Total_amt + $invoicedata->insurance_charge;  ?>
										  <tr>
												<td rowspan="2"  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center"><span style="font-weight:bold;text-align:center;"><span style="text-align:center;font-weight:bold"> Gross Weight</span></span>
												</td>
												<td rowspan="2" colspan="2" style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center"><span style="text-align:center;font-weight:bold">
											...
											KGS</span></td>
												...
												<td rowspan="2"  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:center;"><?=number_format($totalnetweight,2)?> KGS</td>
										 ...
										 <tr>
												 ...
												 <td style="border-right:0.5px solid #333;border-top:0.5px solid #333;text-align:center;">BANK CHARGES</td>
                    <td  style="border-bottom:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:right"><?=$currency_symbol?>
                      <?=($invoicedata->bank_charge > 0)?number_format($invoicedata->bank_charge,2,'.',''):"0.00" ?></td>
									...
									if(!empty($invoicedata->extra_calc_name))
									{
									 	 ...
									 	 ?>
									<tr>
										  <td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="5"> </td>
										<td style="border-right:0.5px solid #333;border-top:0.5px solid #333;text-align:center;" ><?=$invoicedata->extra_calc_name?> <?=($invoicedata->extra_calc_opt == 1)?"+":"-"?></td>
										<td  style="border-bottom:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;text-align:right"><?=$currency_symbol?>
										  <?=number_format($invoicedata->extra_calc_amt,2,'.','')?></td>
														...
														?>
									 <tr>
										<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="6"></td>
										 <td style="border-right:0.5px solid #333;border-top:0.5px solid #333;border-bottom:0.5px solid #333;text-align:center">COURIER CHARGES</td>
                    <td  style="font-weight:bold;text-align:right"><?=$currency_symbol?>
                      ...
                      <?=($invoicedata->courier_charge > 0)?number_format($invoicedata->courier_charge,2,'.',''):"0.00" ?></td>
										  ...
										  <tr>
												<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="6"></td>
											 	...
											 	<td  style="font-weight:bold;text-align:right;border-bottom:0.5px solid #333;">
													<?=$currency_symbol?> <?=($invoicedata->discount > 0)?number_format($invoicedata->discount,2,'.',''):"0.00" ?></td>
										 </tr>
										  <tr>
										    <td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="6">AMOUNT CHARGEABLE IN WORDS <span style="text-align:center">
										      <?=($invoicedata->calculation_operator == 1)? $invoicedata->terms_name: 'FOB';?>
										    </span></td>
										    <td style="border-right:0.5px solid #333;border-top:0.5px solid #333;border-bottom:0.5px solid #333;text-align:center">COMMISSION</td>
										    <td  style="font-weight:bold;text-align:right"><?=$currency_symbol?>&nbsp;  <?=($invoicedata->commision_amt > 0)?number_format($invoicedata->commision_amt,2,'.',''):"0.00" ?></td>
									      </tr>
										  ...
										  ?>
										  <tr>
												<td  style="border-right:0.5px solid #333;border-top:0.5px solid #333;font-weight:bold;vertical-align:top;" colspan="6"><?=strtoupper(convertamonttousd($invoicedata->grand_total,$invoicedata->currency_name))?> ONLY </td>
											 	<td  style="border-right:0.5px solid #333;text-align:center"> 
										 ...
										 <tr>
											<td style="border-top:0.5px solid #333;"  colspan="8">
					 ...
					 <br>
					  ...
					  $no++;
							...
							<table  width="100%" cellspacing="0" cellpadding="0" style="border:none" class="pdf_class invoice_edit_cls1" contenteditable="false">
										...
										?>										
										 ...
										 <tr>
									  	 ...
									  	 <tr>
												<td colspan="3" bgcolor="#000000"  style="vertical-align:top; color: #FFF;"> THE GOODS EXPORT UNDER LETTER OF UNDERTAKING(LUT)  :
							...
							<table  width="100%" cellspacing="0" cellpadding="0" style="border:none" class="pdf_class invoice_edit_cls1" contenteditable="false">
							  ...
							  <tr>
							    <td colspan="9" valign="top" style="text-align:left"><strong> <span style="font-weight:bold;vertical-align:top;">
							      <?php if($invoicedata->remarks!='')
												   {
													?>
							      <?=nl2br($invoicedata->remarks)?>
							  ...
							  <tr>
							    ...
							    <td height="80" colspan="4" style="text-align:left;border-bottom:hidden" valign="top"><span style="border-bottom:hidden">For
							      <?=$company_detail[0]->s_name?>
							      </span></td>
						      </tr>
							  <tr>
							    <td colspan="4" style="text-align:left" valign="top"><?=nl2br($company_detail[0]->authorised_signatury)?></td>
						      </tr>
							  </table>
								<?php
								}
...
BOXES)															 </td>
							  ...
							  <table  width="100%" cellspacing="0" cellpadding="0" style="border:none" class="pdf_class invoice_edit_cls2" contenteditable="false">
													  <tr>
													    <td style="padding:0;border-top:none;border-bottom:none" width="14%"></td>
													    <td style="padding:0;border-top:none;border-bottom:none" width="14%"></td>
													    <td style="padding:0;border-top:none;border-bottom:none" width="14%"></td>
													    <td style="padding:0;border-top:none;border-bottom:none" width="14%"></td>
													  ...
													  <tr>
													    <td style="text-align:center;font-weight:bold" width="15%"> CONTAINER NO </td>
													   <!-- <td style="text-align:center;font-weight:bold" width="15%"> CONTAINER TYPE </td>-->
													    <td style="text-align:center;font-weight:bold" width="15%"> RFID SEAL </td>
													    <td style="text-align:center;font-weight:bold" width="14%">LINE SEAL </td>
														<td style="text-align:center;font-weight:bold" width="14%">PRODUCT</td>
														<td style="text-align:center;font-weight:bold" width="14%">UNIT</td>
													    <td style="text-align:center;font-weight:bold" width="14%">QUANTITY</td>
												
														<td style="text-align:center;font-weight:bold" width="7%">BOXES</td>
																<td style="text-align:center;font-weight:bold" width="7%">PALLETS</td>
												      </tr>
												  <?php
										 	$Grand_Total_pallet = 0;
											$Total_pallets = 0;
											...
											$sizearray = array();
											 $no_of_row = 15;
															...
															if(empty($sample_str))
															{
																...
																foreach($product_data[$i]->sample  as $sample_row)
																{
																	 $rowcon_no++;
																		...
																		$sample_str .= '<tr>
																						 <td style="text-align:center" colspan="2">
																						 	Sample - '.$sample_row->product_size_id.'
												...
												?>
													...
													<td style="text-align:center" ><?=!empty($product_data[$i]->product_id)?$product_data[$i]->size_type_cm:$product_data[$i]->description_goods?></td>
												 	<td style="text-align:center" > <?=$product_data[$i]->per?></td>
													<td style="text-align:center" ><?=$qty?></td>
