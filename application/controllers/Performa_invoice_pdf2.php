...
class Performa_invoice_pdf2 extends CI_controller
{
	...
	function index($id){
			...
			$menu_data			= $this->menu->usermain_menu($this->session->usertype_id);	
			 	$html_data	 	= 	$this->pinv->get_invoice_html($id,'performa_invoice_pdf2');
			...
			$this->load->view('admin/performa_invoice_pdf2',$v);
		}
		else
		{
			redirect(base_url().'');
