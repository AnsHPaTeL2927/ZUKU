...
class Proforma_data extends CI_controller{
	...
	public function __construct(){
 	...
 	public function index()
 	{
			if(!empty($this->session->id)  && $this->session->title == TITLE)
		 {
			...
			$this->load->view('admin/proforma_data',$data);	
		}
		else
		{
			redirect(base_url().'');
	...
	public function view_report()
	{
		...
		$resultdata		=	$this->performa->get_confirm_performa1($customer_id,$invoicedate[0],$invoicedate[1]);
		$str = '<div class="table-responsive">
					<table class="table table-bordered table-hover" >
						...
						<tr>
							...
							<th class="text-center" width="8%">finish </th>
						 	<th class="text-center" width="6%">Pallet </th>
							<th class="text-center" width="6%">Total Boxes </th>
							<th class="text-center" width="6%">Sqm </th>
		...
		foreach($resultdata as $row)
		{
			...
			$str .= '<tr>
							...
							<td class="text-center">'.$row->finish_name.'</td>
					 		<td class="text-center">'.$row->total_no_of_pallet.'</td>
					 		<td class="text-center">'.$row->total_no_of_boxes.'</td>
							<td class="text-center">'.number_format($row->total_no_of_sqm,2,'.','').'</td>
							<td class="text-center">'.number_format($row->total_product_amt,2,'.','').'</td>
