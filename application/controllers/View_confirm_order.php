...
class View_confirm_order extends CI_controller{
	...
	public function view_pdf()
 	{
		$this->load->view('admin/view_confirm_order_pdf');
	}
	...
	public function view_report()
	{
		...
		$resultdata		=	$this->order->get_confirm_performa($customer_id,$finish_id,$size_id,$pallet_type,$invoicedate[0],$invoicedate[1]);
		$str = '<div class="table-responsive">
					<table class="table table-bordered table-hover" >
						<tr>
							<th colspan="10" class="text-center">Confim Order</th>
						</tr>
						<tr>
							<th>Sr No</th>
