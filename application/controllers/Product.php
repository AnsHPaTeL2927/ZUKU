...
class Product extends CI_controller
{
			...
			if(empty($id))
			{
				...
				foreach($this->input->post('design_id') as $design)
				{
					...
					$packing_data = array(
						...
						"agent_product_rate" 			 => $this->input->post('agent_product_rate')[$no],
						...
						"agent_product_amt" 			 => $this->input->post('agent_product_amt')[$no],
	...
	public function load_packing()
	{
		...
		$str = '<div class="col-md-8">
				...
				<tr>
					<td width="8%">Design</td>
					<td width="8%">Finish</td>
					<td width="6%">Client Name </td>
					<td width="6%">Barcode </td>
					<td width="6%">Rate </td>
					<td width="5%">Agent Rate </td>
					<td width="8%">Rate In</td>
					<td width="6%" class="pallet_calcution multi_pallet_calcution">No Of Pallet </td>
					<td width="8%" class="pallet_calcution multi_pallet_calcution">Pallet Type</td>
					<td width="7%">Boxes</td>
					<td width="9%">Box Design</td>
					<td width="7%"> SQM</td>
					<td width="10%">Amount</td>
					<td width="5%">Agent Amount</td>
					<td width="2%">Add</td>
				</tr>';
				if(strtolower($mode)=="edit")
				{
						...
						foreach($getpacking_detail as $row)
						{
							...
							$pallet_type_id				= $row->pallet_type_id;
						 	...
						 	$str .='<tr class="appendtr'.$no.'">
									...
									$str .= '</select>
										...
										<td class="">
											<input type="text" name="agent_product_rate[]" id="agent_product_rate'.$no.'" class="form-control" onkeypress="return isNumber(event)" onkeyup="cal_product_trn('.$no.')"   onblur="cal_product_trn('.$no.')" value="'.number_format($row->agent_product_rate,2).'" />
										</td>
							...
							$str .= '</select>
										...
										<td class="">
											<input '.$disable.'   type="text" name="agent_product_amt[]" id="agent_product_amt'.$no.'" class="form-control"  value="'.$row->agent_product_amt.'"/>
										</td>
										';
				...
				<tr class="appendtr1">
					...
					$str .= '</select>
						...
						<td class="">
							<input type="text" name="agent_product_rate[]" id="agent_product_rate1" class="form-control" onkeypress="return isNumber(event)" onkeyup="cal_product_trn(1)"  onblur="cal_product_trn(1)" />
						</td>
						<td class="">
						...
						<td class="">
							<input type="text" name="agent_product_amt[]" id="agent_product_amt1" class="form-control" readonly />
						</td>
						<td class="">
		...
		$allproduct = 	$this->pinv->allsizeproduct();
		 ...
		 $str ='<tr class="last_row'.$no.'">
			...
			$str .='</select>
						...
						<td class="text-center">
							<input type="text" name="agent_product_rate[]" id="agent_product_rate'.$no.'" class="form-control" onkeypress="return isNumber(event)" onkeyup="cal_wallproduct_invoice('.$no.')"   onblur="cal_wallproduct_invoice('.$no.')" value="" />
						</td>
						<td class="">
						...
						<td class="text-center">
							<input type="text" name="agent_product_amt[]" id="agent_product_amt'.$no.'" class="form-control" readonly />
					 	</td>
						<td class="text-center">
	...
	public function add_design_row()
	{
		...
		$str .='<tr class="appendtr'.$no.'">
				...
				$str .= '</select>
						...
						<td class="">
							<input type="text" name="agent_product_rate[]" id="agent_product_rate'.$no.'" class="form-control" onkeypress="return isNumber(event)" onkeyup="cal_product_trn('.$no.')"  onblur="cal_product_trn('.$no.')" />
						</td>
						<td class="">
						...
						<td class="">
							<input type="text" name="agent_product_amt[]" id="agent_product_amt'.$no.'" class="form-control" readonly  value=""/>
						</td>
						<td class="">
							<button type="button" onclick="remove_row('.$no.')" class="btn btn-danger">-</button>
						</td>
