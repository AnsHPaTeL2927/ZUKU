...
class Performa_invoice_pdf4 extends CI_controller
{
		...
		if(!empty($this->session->id)  && $this->session->title == TITLE)
		 {
			...
			$html_data	 		= 	$this->pinv->get_invoice_html($id,'performa_invoice_pdf4');
			...
			$this->load->view('admin/performa_invoice_pdf4',$v);
		}
		else
		{
			redirect(base_url().'');
