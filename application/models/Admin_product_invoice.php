...
class Admin_product_invoice extends CI_model
{
	...
	public function productdata_select($id)
	{
		...
		mst.boxes_per_pallet, pro_size.total_pallent_container, pro_size.no_big_plt_container_new, pro_size.no_small_plt_container_new, pro_size.weight_per_box, pro_size.box_per_container, pro_size.multi_box_per_container, pro_size.total_boxes
		")
